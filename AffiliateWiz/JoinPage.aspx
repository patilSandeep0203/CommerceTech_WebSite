<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JoinPage.aspx.cs" Inherits="Join"
    Theme="AppTheme" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ScriptManager ID="ScriptManager1" runat="server">
                ...
                <asp:Panel ID="pnlMain" runat="server" Width="550px" Visible="False">
                <table border="0" cellspacing="2" cellpadding="0" style="width: 550px" class="SilverBorder">
                    ...
                    <tr>
                        ...
                        <asp:DropDownList ID="lstReferralID" runat="server" TabIndex="17" AutoPostBack="true" OnSelectedIndexChanged="lstReferralID_SelectedIndexChanged" >
                    ...
                    <tr>
                        <td colspan="2" align="center" style="height: 30px;" class="DivHeader">
                            <span style="font-family: Arial; font-size: x-small; color: White">Copyright © 2019
            ...
            <asp:Panel ID="pnlGrid" runat="server" Style="border-right: silver thin solid; border-top: silver thin solid;
                ...
                <asp:Table ID="tblReferral" runat="server" CellPadding="2" CellSpacing="0" GridLines="Vertical">
    </asp:Table>
