...
<%@ Page Language="c#" AutoEventWireup="false" CodeFile="UploadPDF.aspx.cs" Inherits="netimageupload.uploadfiles"
        ...
        <table style="width: 600px" class="SilverBorder" align="center">
            <tr>
                <td align="center" style="background-image: url(Images/topMain.gif); height: 25px" colspan="2">
                    <span class="MenuHeader"><b>Upload Signed App</b></span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right"; style="width:45%">
                    <asp:Label ID="lblFileName" Text="Choose file to upload" runat="server"></asp:Label>
                </td>
                <td style="width:55%">
