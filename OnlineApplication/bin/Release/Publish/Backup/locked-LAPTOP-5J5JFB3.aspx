...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentHolder" Runat="Server">
    ...
    <br />
    <br />
    <asp:Panel ID="pnlMessage" class="DivGreen" BorderColor="gray" BorderWidth="1px" runat="server" Font-Bold="True"
        Width="99%">
        <span class="LabelsBody"> The status of your application prevents it from being edited. If you have any questions,
        please contact 1-800-477-5363 option 3 or Email
        <br />
        <asp:HyperLink ID="lnkEmail" CssClass="Link" runat="server" NavigateUrl="mailto:applications@commercetech.com">applications@commercetech.com</asp:HyperLink></span></asp:Panel>
    <br />
    <br />
</asp:Content>
