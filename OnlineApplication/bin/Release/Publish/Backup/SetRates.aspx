                                ...
                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                    ...
                                    <asp:Panel ID="pnlMerchantRates" runat="server" Width="100%" Visible="False">
                                        ...
                                        <tr style="height: 24px;">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtDRQD" runat="server" Width="40px" TabIndex="8" MaxLength="6" OnTextChanged="txtDRQD_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <td align="right">
                                            ...
                                            <td align="left">
                                               <asp:TextBox ID="txtQualNPDebit" runat="server" Width="40px" TabIndex="8" MaxLength="6" OnTextChanged="txtQualNPDebit_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                <span class="LabelsSmall">%</span>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" style="width: 1000px">
                                    ...
                                    <asp:Panel ID="pnlGatewayRates" runat="server" Width="100%" Visible="False">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" colspan="4" width="167px" >
                                            ...
                                            <td align="right" valign="middle">
                                                <span class="LabelsSmall">Monthly Fee</span>&nbsp;</td>
                                            <td align="left" valign="middle" width="57px">
                                                <span class="LabelsSmall">$</span>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        ...
                                        <tr>
                                            <td align="center">
                                                            ...
                                                            &nbsp; &nbsp; &nbsp;
                                                                <asp:CheckBox ID="chkCheckGuarantee" runat="server" AutoPostBack="true" Font-Bold="True"
                                                                    Text="Check/ACH" OnCheckedChanged="chkCheckGuarantee_CheckedChanged" /></td>
                                                                        ...
                                                                        <td align="left" colspan="1" width="120px">
                                                                        ...
                                                                        <td align="left" width="40px">
                                                                        	<asp:TextBox ID="txtCGDiscRate" runat="server" MaxLength="5" Width="40px" TabIndex="33"></asp:TextBox><span class="LabelsSmall">&nbsp;%</span></td>
                                                                        	<td align="left" colspan="1" width="15px"></td>
                                                                        <td align="right">
                                                                            <span class="LabelsSmall">Monthly Fee $</span>&nbsp;</td>
                                                                        <td align="left" width="40px" >
                                                                        ...
                                                                        <td align="left" width="40px">
                                                                            ...
                                                                            <td align="left" colspan="1" width="10px">
                                                                            </td>
                                                ...
                                                <span class="LabelsSmall"></span>&nbsp;</td>
                                            <td align="left" valign="middle" style="height: 24px; width: 91px" colspan="2">
                                                ...
                                                <asp:Panel ID="pnlLease" runat="server" Width="100%">
                                                    <table cellpadding="0" cellspacing="0" border="0" style="width: 1000px;">
                                                        <tr>
                                                            ...
                                                            <td align="left" width="57px">
                                                                <asp:TextBox ID="txtLeasePayment"  runat="server" TabIndex="41" Width="40px" MaxLength="7"></asp:TextBox></td>
                                                            <td align="right" >
                                                                <span class="LabelsSmall">Lease Term</span>&nbsp;</td>
                                                            <td align="left" width="43px">
                                                                <asp:DropDownList ID="lstLeaseTerm" runat="server" TabIndex="42" Width="40px">
                                                                    <asp:ListItem Text="" Selected="True" />
                                                ...
                                                <span class="LabelsSmall"></span>&nbsp;</td>
                                                      ...
                                                      <asp:Panel ID = "Gift" runat = "server">                                     
                                                    <table cellpadding="0" cellspacing="0" border="0" style="width: 1000px;">
                                                        <tr>
                                                            <td align="left" colspan="2"  width="15%" valign="top">
                                                             &nbsp; &nbsp; &nbsp;
                                                            ...
                                                            <td align="left" colspan="2" width="120px" >
                                                                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" TabIndex="36" OnSelectedIndexChanged="lstGiftCard_SelectedIndexChanged">
                                                                    <asp:ListItem Text="" Selected="True" />
                                                                    <asp:ListItem Text="Sage EFT Gift & Loyalty" />
                                                                </asp:DropDownList>
                                                            </td>
                                                            ...
                                                            <td align="right" >
                                                                <span class="LabelsSmall">Monthly Fee $</span>&nbsp;</td>
                                                            <td align="left" width="57px">
                                                                <asp:TextBox ID="TextBox1" MaxLength="5" runat="server" TabIndex="37" Width="40px"></asp:TextBox></td>

                                                            <td align="right" >
                                                                <span class="LabelsSmall">Transaction Fee $</span>&nbsp;</td>
                                                            <td align="left" width="43px">
                                                                <asp:TextBox ID="TextBox2" MaxLength="5" runat="server" TabIndex="38" Width="40px"></asp:TextBox></td>
