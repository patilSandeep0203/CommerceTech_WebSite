                    ...
                    else if (iValidate == 3)
                    {
                        ...
                        if (strRedirectURL == null)
                        {
                            ...
                            if (Session["Locked"].ToString().Trim() == "Yes")
                            {
                                ...
                                {
                                    Response.Redirect("/OnlineApplication/locked.aspx", false);
                                }
                            }
                            ...
                            else if ((strRedirectFlag == "Merchant") && (!(Status.ToLower().Contains("completed"))))
                            {
                                ...
                                {
                                    Response.Redirect("/OnlineApplication/Merchant/companyinfo.aspx?EditCompany=True", false);
                                }
                                else if (busCom == 0)
                                {
                            ...
                            {
                                Response.Redirect("/OnlineApplication/Gateway/company.aspx", false);
                            }
                            else if ((strRedirectFlag == "Merchant") && (!(StatusGW.ToLower().Contains("completed"))))
                            {
                                if (companyCom == 0)
                                {
                                    Response.Redirect("/OnlineApplication/Gateway/companyinfo.aspx", false);
                                }
                                else if (busComGW == 0)
                                {
                                    Response.Redirect("/OnlineApplication/Gateway/businessinfo.aspx?EditBusiness=True", false);
                                }
                                else if (principalComGW == 0)
                                {
                                    Response.Redirect("/OnlineApplication/Gateway/principalinfo.aspx?EditPrincipal=True", false);
                                }
                                else if (bankComGW == 0)
                                {
                                    Response.Redirect("/OnlineApplication/Gateway/banking.aspx", false);
                                }
                                else if (ReprogramComGW == 0)
                                {
                                    Response.Redirect("/OnlineApplication/Gateway/reprogram.aspx?EditPlatform=True", false);
                                }
                            }
                            ...
                            else if (strRedirectFlag == "QuickBooks")
                            {
                                ...
                                //Response.Redirect("http://www.firstaffiliates.com/quickbooks", false);
