...
<asp:Panel ID="pnlMainPage" runat="server">
    <table border="0" cellpadding="2" cellspacing="0" Width="100%" class="DivGreen">
        ...
        <tr>
            ...
            <cc1:PopupControlExtender ID="PopupControlExtenderpnlSwiped" runat="server" PopupControlID="pnlSwiped"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr valign="bottom">
                        <td align="left">
                            ...
                            <asp:Image ID="imgSwiped" runat="server" ImageUrl="/Application/Images/help.gif" ToolTip="Help" />
                        ...
                        <td align="left">
                            ...
                            <span class="LabelsBodySmall">%</span><span class="LabelsRedLarge">*</span> 
                                ...
                                <asp:Image ID="imgKeyedWithout" runat="server" ImageUrl="/Application/Images/help.gif" ToolTip="Help"/>
...
<asp:Button ID="btnDoNotNavigate" OnClick="btnDoNotNavigate_Click" runat="server" Text="No" />
    ...
    <asp:Panel ID="pnlSwiped" runat="server" Style="display: none; z-index: 1; text-align: center;" Width="250px"  CssClass="DivHelp">
