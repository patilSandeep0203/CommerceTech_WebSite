        ...
        <div>
            ...
            <asp:ScriptManager ID="ScriptManager1" runat="server">
                ...
                <table border="0" cellspacing="2" cellpadding="0" style="width: 550px" class="SilverBorder">
                    <tr>
                        <td align="center" style="height: 30px;" colspan="2" class="DivHeaderJoinASPX">
                            <b>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <cc1:PopupControlExtender ID="PopupControlExtender2" runat="server" PopupControlID="pnlBLN" TargetControlID="imgBLN"
                                    Position="Bottom" />
                            ...
                            <span class="LabelsRedLarge">*<asp:RequiredFieldValidator ID="ValidatorCompanyName"
                                ...
                                ErrorMessage="Company Name"></asp:RequiredFieldValidator></span>
                            <asp:Image ID="imgBLN" runat="server" ImageUrl="/Images/help.gif"
                                        ToolTip="Business Legal Name Help" />
                            <asp:Panel Style="display: none; z-index: 1;" ID="pnlBLN" runat="server" Width="400px"
                                        CssClass="DivHelp">
                    ...
                    <tr>
                        ...
                        <td align="left">
                             <cc1:PopupControlExtender ID="PopupControlExtender1" runat="server" PopupControlID="pnlDBA" TargetControlID="imgDBA"
                                    Position="Bottom" />
                            ...
                            <span class="LabelsRedLarge">*<asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                runat="server" ControlToValidate="txtDBAName" ErrorMessage="DBA" EnableClientScript="False"></asp:RequiredFieldValidator></span>
                            <asp:Image ID="imgDBA" runat="server" ImageUrl="/Images/help.gif"
                                        ToolTip="DBA Help" />
                            <asp:Panel Style="display: none; z-index: 1;" ID="pnlDBA" runat="server" Width="400px"
                                        CssClass="DivHelp">
                    ...
                    <tr>
                        ...
                        <cc1:PopupControlExtender ID="PopupControlExtender3" runat="server" PopupControlID="pnlShipTo" TargetControlID="imgShipTo"
	                        Position="Bottom" />
                        <asp:Image ID="imgShipTo" runat="server" ImageUrl="/../Images/help.gif"
	                        ToolTip="Physical Address" />
                        <asp:Panel Style="display: none; z-index: 1;" ID="pnlShipTo" runat="server" Width="400px"
	                        CssClass="DivHelp">
                        ...
                        <td align="left">
                            <asp:TextBox ID="Addr2Txt" runat="server" Width="140px" TabIndex="12" MaxLength="100"></asp:TextBox>
                            </td>
                    </tr>
                    <tr>
                        <td align="right">
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <span class="LabelsBodySmall"></span></td>
                        <td align="left">
                            <asp:TextBox ID="AddrTxt2" runat="server" Width="140px" TabIndex="12" MaxLength="100"></asp:TextBox>
                            </td>
                    </tr>
                                        <tr>
                                            <td align="right">
                    ...
                    <tr>
                        <td align="right" valign="middle">
                            <asp:HyperLink ID="lnkW9" runat="server" CssClass="Link" NavigateUrl="https://commercetechnologies.sharepoint.com/:b:/s/Sales/EZYtzmGKoe5BlS1W8jWIzA4BS5TSOzthpN6CTM6HH9SfTw?e=xaWxH5" Target="_blank" Font-Names="Arial"
                    ...
                    <tr>
                        <td align="right" valign="middle">
                            ...
                            NavigateUrl="https://commercetechnologies.sharepoint.com/:b:/s/Sales/ERYQJGcAVslBtlUrZWgd_uwBvxWNZLAxNeheympMCGpo-g?e=3nctlI" Target="_blank"
                    ...
                    <div class="g-recaptcha" data-sitekey="6Ld4rqEaAAAAAFQhkWlvLmlvQK4906E4f28t5JDA"></div>
                    </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2" valign="middle">
                    ...
                    <tr>
                        <td colspan="2" align="center" style="height: 30px;" class="DivHeaderJoinASPX">
                            <span style="font-family: Arial; font-size: x-small; color: White">Copyright © 2022
