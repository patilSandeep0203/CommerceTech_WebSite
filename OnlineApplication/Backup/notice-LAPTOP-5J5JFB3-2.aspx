...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentHolder" runat="Server">
    ...
    <table border="0" cellpadding="2" cellspacing="0" width="100%" class="DivGreen">
        ...
        <tr>
            <td align="center">
            <asp:Panel ID="uploadDocuSignDocs" runat="server" Width="100%" Visible="true">
            ...
            <span class="LabelsBody">Click on the "PDF Application" button below and follow these instructions to complete the application process manually:</span>
                <ul class="LabelsBody" style="margin-left:50px; margin-top:0px; margin-bottom:0px;">
        ...
        <tr>
            ...
            <span class="LabelsBody">Alternatively, click on the "DocuSign Application" below to complete the application process electronically.</span>
                <ul class="LabelsBody" style="margin-left:50px; margin-top:0px; margin-bottom:0px;">
