...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
            ...
            <td valign="top" align="center" width="33%">
                ...
                <table border="0" cellspacing="2" style="width: 95%" class="SilverBorder">
                   ...
                   <tr>
                    ...
                    <tr>
                        <td style="background-image: url('Images/homeback.gif');" class="SilverBorder">
                            <b><span class="LabelsRed">Lightspeed</span></b></td>
                    </tr>
                    <tr>
                        <td>
                            <a class="One" href="https://www.lightspeedhq.com/referral/?utm_medium=partner&utm_source=Reseller&utm_campaign=0014w00002socIDAAY&ref=0014w00002socIDAAY" target="_blank">Lightspeed Lead Submission Form</a></td>
                    </tr>
                    <!-- <tr>
                        <td>
                    ...
                    <tr>
	                    <td>
		                    <a class="One" href="https://intuit.portal.ziftprm.com/fileManagement/FileGet.cfm?fileId=427"
		                    target="_blank">QuickBooks POS 30-Day Trial</a>
	                    </td>
                    </tr>
                    ...
                    <tr>
	                    <td>
		                    <a class="One" href="https://go.webgility.com/lp-certified-partner?partner_id=0034A00003RUkYg"
 ...
 <tr>
                    ...
                    <tr>
                        <td>
                            <asp:HyperLink CssClass="One" ID="lnkTasq" runat="server" Target="_blank" NavigateUrl="https://www.shopmerchantsupplies.com/SF8/CustSignIn.aspx">TASQ/First Data Hardware Services  Login</asp:HyperLink>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <!--<tr>
                        <td>
                            <a class="One" href="../IMS%20forms/IMS%20Product%20Matrix.xls" target="_blank">Product Matrix</a></td>
                                        ...
                                        <tr>
                        <td>
                            <a class="One" href="https://intuit.learnupon.com/users/sign_in?next=%2Fdashboard" target="_blank">QSP University</a></td>
                    </tr>
...
" target="_blank">Price Sheet</a></td>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>
                                <a class="One" href="https://live.pivotalpayments.com/" target="_blank">Nuvei/Pivotal Live</a></td>
                        </tr>
            ...
            <td align="center" valign="top" width="33%">
                    ...
                    <tr>
                        <td>
                            <asp:HyperLink CssClass="One" Font-Names="Arial" Font-Size="Small" ID="HyperLink10"
                                runat="server" Target="_blank" NavigateUrl="https://www.authorize.net/newmerchanttraining/">Authorize.Net videos</asp:HyperLink>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table border="0" cellspacing="2" style="width: 95%" class="SilverBorder">
                    ...
                    <tr>
                        <td style="background-image: url('Images/homeback.gif');" class="SilverBorder">
                            <b><span class="LabelsRed">Paya/Sage Payment Solutions EFT </span></b></td>
                    </tr>
                    <tr>
                        <td>
