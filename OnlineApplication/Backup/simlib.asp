...
//***   for testing only:   ***********************************
// var tstamp = 1050143570;

var fingerprint = CalculateFP (loginid, txnkey, amount, sequence, tstamp, currency);

Response.Write ('<input type="hidden" name="x_fp_sequence" value="' + sequence + '" style="width:300;"> ' );
Response.Write("<br>")
Response.Write ('<input type="hidden" name="x_fp_timestamp" value="' + tstamp + '" style="width:300;"> ' );
Response.Write("<br>")
Response.Write ('<input type="hidden" name="x_fp_hash" value="' + fingerprint + '" style="width:300;"> ' );
Response.Write("<br>")
