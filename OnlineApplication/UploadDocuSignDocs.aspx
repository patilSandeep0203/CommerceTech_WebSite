...
<asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <tr>
            ...
            <span class="LabelsBody"><b>To verify banking information entered, upload:</b></span>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <asp:Label ID="lblFileName" Text="To verify banking information entered, upload" runat="server">
                     <span class="LabelsBody"></span>
                    <ul class="LabelsBody" style="margin-left:50px; margin-top:0px; margin-bottom:0px;" align="left"> 
                <li>a new, voided or cancelled/cleared check pre-printed with your business/personal name</li>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <span class="LabelsBody"><b>For additional verification, upload: </b></span> <br/><br/>
                    <ul class="LabelsBody" style="margin-left:50px; margin-top:0px; margin-bottom:0px;" align="left"> 
                <li>a Business license</li>
                <li>or phone or utility bill</li>
                <li>or previous processing statement</li></ul> 
           ...
           <tr height="25px"></tr>
             ...
             <tr>
                <td align="center" height: 25px" colspan="2">
                    <asp:Panel ID="Panel1" runat="server" Width=100% Visible="True"><asp:Label ID="Label3" runat="server" ></asp:Label>
            <span class="LabelsBody">Click on "Upload" the above documents or fax/email them to 310-321-5410/applications@commercetech.com:</span>
                <!--<ul class="LabelsBody" style="margin-left:50px; margin-top:0px; margin-bottom:0px;">
                <li>Voided or cancelled check pre-printed with your business name (in place of a temporary check, 
                            a bank signed letter with full account, routing number and business name will need to be provided)</li>
                <li>Business license, phone or utility bill or previous processing statement</li></ul> -->
            ...
            <tr>
                <td height="50px" align="center">
                    <asp:Button ID="btnUpload" runat="server" Text="Up-Test" Width="90px" Height="25px"></asp:Button>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" align="center" >
                    <asp:Label ID="Label1" Font-Size="12px" Text="Supported file format: pdf, jpg, doc, docx, txt, tif, png, xls, xlsx." runat="server"></asp:Label>
                </td>
            </tr>
        </table>
