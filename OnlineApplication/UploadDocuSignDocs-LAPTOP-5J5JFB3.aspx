...
<asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <tr>
            ...
            <span >Click on "Choose file" to attach then click "Upload" the following documents or fax/email them to 310-321-5410/applications@commercetech.com:</span>
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="lblFileName" Text="Voided, cancelled or blank check pre-printed with your business name (in place of a temporary check, a bank signed letter with full account, routing number and business name will need to be provided). Or a person check for Sole Proprietors ONLY." runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
            <td colspan="2" align="center">
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="Label2" Text="Upload a Business license, phone or utility bill or previous processing statement" runat="server"></asp:Label>
                </td> 
            </tr>
            <tr>
                    <td colspan="2" align="center">
