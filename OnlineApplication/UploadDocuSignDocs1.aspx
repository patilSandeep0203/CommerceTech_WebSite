...
<asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <tr>
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="lblFileName" Text="Voided or cancelled check pre-printed with your business name (in place of a temporary check, 
                            a bank signed letter with full account, routing number and business name will need to be provided)" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
            <td colspan="2" align="center">
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="Label2" Text="Please upload a Business license, phone or utility bill or previous processing statement" runat="server"></asp:Label>
                </td> 
            </tr>
            <tr>
                    <td colspan="2" align="center">
