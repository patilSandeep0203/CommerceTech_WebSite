...
namespace netimageupload
{
    ...
    public partial class uploadfiles : System.Web.UI.Page
    {
        ...
        private void btnUpload_Click(object sender, System.EventArgs e)
        {
            ...
            sNewPath = "F:\\DATA\\SharedData\\Shared\\Customers\\" + strP1Initial + "/" + strP1LastName + ", " + strP1FirstName + "/";
            // testing
            ...
            sSavePath = "F:\\DATA\\SharedData\\Shared\\Customers\\" + strP1Initial + "/" + strP1LastName + ", " + strP1FirstName + "/";
        ...
        public void SendEmail(int AppId)
        {
            try
            {
                ...
                string strSubject = "File uploaded";
                MailMessage msg = new MailMessage();

                msg.From = new MailAddress("crenteria@commercetech.com");
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    /*if ((RepCategory == "A") || (RepCategory == "R"))
                    {
                        ...
                        msg.To.Add(new MailAddress("crenteria@commercetech.com"));
                        msg.To.Add(new MailAddress("crenteria@commercetech.com"));
                ...
                msg.Body = "File uploaded";


                System.Net.Mail.MailMessage mail = new System.Net.Mail.MailMessage("crenteria@commercetech.com", "crenteria@commercetech.com", "File uploaded", msg.Body);
                //pasing the Gmail credentials to send the email


                System.Net.NetworkCredential mailAuthenticaion = new System.Net.NetworkCredential("crenteria@commercetech.com", "1Success11");
