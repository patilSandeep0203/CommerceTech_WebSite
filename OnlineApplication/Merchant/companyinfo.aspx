    ...
    <asp:Panel ID="pnlMainPage" runat="server">
        <table border="0" cellpadding="2" cellspacing="0" Width="100%" class="DivGreen">
            ...
            <tr>
                ...
                <td colspan="2" align="left">
                    <asp:TextBox ID="txtCity" runat="server" Width="140px" MaxLength="45" TabIndex="5" OnTextChanged="textChangedEventHandler"></asp:TextBox><span
                        style="color: #ff0000">*</span>
