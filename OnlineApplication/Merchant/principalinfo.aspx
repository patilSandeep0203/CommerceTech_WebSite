        ...
        <table border="0" cellpadding="2" cellspacing="0" Width="100%" class="DivGreen">
           ...
           runat="server"/>
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <asp:TextBox ID="txtP1City" runat="server" MaxLength="45" Width="140px" TabIndex="10" OnTextChanged="textChangedEventHandler"></asp:TextBox><span
                        style="color: red">*</span>
...
<asp:Button ID="btnDoNotNavigate" OnClick="btnDoNotNavigate_Click" runat="server" Text="No" />
           ...
           runat="server"/>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="2">
                                    <asp:TextBox ID="txtP2City" runat="server" MaxLength="45" Width="140px" TabIndex="34" OnTextChanged="textChangedEventHandler"></asp:TextBox><span
                                        style="color: red">*</span>
