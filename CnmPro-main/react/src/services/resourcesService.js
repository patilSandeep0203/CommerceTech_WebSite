...
const getResourceByResourceCategoryId = (resourceId, pageIndex, pageSize) => {
    const config = {
        method: 'GET',
        url: `${resourcesApi}/type/?resourceCatId=${resourceId}&pageIndex=${pageIndex}&pageSize=${pageSize}`,
        withCredentials: true,
        crossdomain: true,
        headers: { 'Content-Type': 'application/json' },
    };
...
const searchResourceByKeyWord = (pageIndex, pageSize, keyword) => {
    const config = {
        method: 'GET',
        url: `${resourcesApi}/search/?pageIndex=${pageIndex}&pageSize=${pageSize}&query=${keyword}`,
        withCredentials: true,
        crossdomain: true,
        headers: { 'Content-Type': 'application/json' },
    };
...
export {
    ...
    getAllResources,
    deleteResource,
    getResourceByIdDetails,
    getResourceByResourceCategoryId,
    createResource,
    updateResource,
