...
function ResourceWithDetails() {
    ...
    return (
        <Row className="align-items-center mr-0 ml-0">
            <Card className="col-6 mt-3 mb-3 shadow">
                <Col className="card-body col-10 ml-3">
                    <Row>
                        ...
                        <h4 className="card-text card-title">
                            Organization Name: {resourceCardData.organization.name}
                        </h4>
                        <h5 className="card-text">
                            Organization Description: {resourceCardData.organization.description}
                        </h5>
                        ...
                        <h5 className="card-text">
                            ...
                            {resourceCardData.organization.location.state.name}{' '}
                            {resourceCardData.organization.location.zip}
                        </h5>
            ...
            <Col className="col-6">
                <div className="res-img-container">
                    <img src={resourceCardData.logo} alt="Resource Logo" className="details-img shadow" />
                </div>
            </Col>
        </Row>
    );
