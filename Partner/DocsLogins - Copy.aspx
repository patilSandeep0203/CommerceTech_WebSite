<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="DocsLogins.aspx.cs"
    Inherits="DocsLogins" Title="Commerce Technologies - Partner Portal" Theme="AppTheme" %>
        ...
        <tr>
            <td valign="top" align="center" width="33%">
                <table width="95%" border="0" cellspacing="2" class="SilverBorder">
                    ...
                    <tr>
                        <td>
                            <asp:HyperLink CssClass="One" ID="lnkACTforWeb" runat="server" NavigateUrl="https://apps.commercetech.com/APFW/default.aspx/">ACT for Web</asp:HyperLink>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:HyperLink CssClass="One" ID="HyperLink8" runat="server" Target="_blank" NavigateUrl="https://www.fidelity.com/">Fidelity</asp:HyperLink>&nbsp;</td>
                    </tr>
                        ...
                        <tr>
                            <td>
                                <asp:HyperLink CssClass="One" ID="HyperLink3" runat="server" NavigateUrl="http://www.godaddy.com/"
                                    Target="_blank">Godaddy (Email and Ecenow)</asp:HyperLink>&nbsp;</td>
                        </tr>
                        <tr>
                            <td>
                ...
                <table border="0" cellspacing="2" style="width: 95%" class="SilverBorder">
                    ...
                    <tr>
                        <td style="background-image: url('Images/homeback.gif');" class="SilverBorder">
                            <b><span class="LabelsRed">Verifone Cloud POS</span></b></td>
                    </tr>
                    <tr>
                        <td>
                            <a class="One" href="https://verifonecloudpos.com/" target="_blank">
                                Verifone Cloud POS Website </a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://comtech.revelup.com/login/"
                                target="_blank">Revel Login</a></td>
                    </tr>
                    <tr>
                        <td>
                            <a class="One" href="https://intuitevents.webex.com/intuitevents/lsr.php?RCID=37ef39b484a94543a7414809120000af"
                                target="_blank">Revel Overview </a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a class="One" href="https://intuitcorp.webex.com/intuitcorp/lsr.php?RCID=5b8a31282e0d42edad664b15454a8fe0"
                                target="_blank">How to Sell Revel</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a class="One" href="/Equipment and Supplies/Manufacturers/Quickbooks POS/Revel/Marketing/Selling on Value_Agent Only.ppt"
                                target="_blank">Selling on Value (Internal Use)</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 20px; background-image: url('Images/topMain.gif')">
                    ...
                    <tr>
                        <td>
                            <a class="One" href="http://http-download.intuit.com/http.intuit/Downloads/2015/Latest/Setup_QuickBooksPOSV12Trial30.exe"
                                target="_blank">Intuit POS v12 Desktop Trial Download </a>
                        </td>
                    </tr>
                    <tr>
                        <td style="background-image: url('Images/homeback.gif');" class="SilverBorder">
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://apps.commercetech.com/Affiliatewiz/Verifone_VX805_DataCap_FD_Rapid_Connect.pdf"
                                target="_blank">Verifone VX 805 with First Data Rapid Connect</a>
                        </td>
                    </tr>
            ...
            <td valign="top" align="center" width="34%">
                <table width="95%" border="0" cellspacing="2" class="SilverBorder">
                    ...
                    <tr>
                        <td>
                            <a class="One" href="../Sage/Forms/Applications/Application for Merchant Account.pdf" target="_blank">Merchant
                                Application</a></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td style="background-image: url('Images/homeback.gif');" class="SilverBorder">
                            <b><span class="LabelsRed">Pivotal</span></b></td>
                    </tr>
                        <tr>
                            <td>
                                <a class="One" href="https://live.pivotalpayments.com/" target="_blank">Pivotal Live</a></td>
                        </tr>
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://partners.agentusers.com/#splash" target="_blank">iPayment partner
                                Login</a></td>
                    </tr>
                    <!--<tr>
                        <td>
            ...
            <td align="center" valign="top" width="33%">
                <table border="0" cellspacing="2" style="width: 95%;" class="SilverBorder">
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://support.sagepayments.com/ics/support/KBAnswer.asp?questionID=3411" target="_blank">Sage VT/Shopping Cart Integration</a></td>
                    </tr>
                    <tr>
                    <td>
                            <a class="One" href="https://www.youtube.com/user/SageExchange" target="_blank">Sage Exchange Portal training</a></td>
                    </tr>
                ...
                <table border="0" cellspacing="2" style="width: 95%;" class="SilverBorder">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>
                            <a class="One" href="https://www.youtube.com/watch?v=TnCXz4rEgv0&feature=youtu.be&t=3m" target="_blank">How To Sell Gift & Loyalty Programs</a></td>
                    </tr>
                    <!--<tr>
                        <td>
                            <a class="One" href="http://www.myonlinereports.com" target="_blank">Admin Login</a></td>
                ...
                <table border="0" cellspacing="2" style="width: 95%;" class="SilverBorder">
                    ...
                    <tr>
                        <td>
                            <a class="One" href="../Merchant Cash Advance/Business Financial Services/Forms/Application/Cash Advance Program Procedures_iPayment.pdf"
                    ...
                    <tr>
                        <td>
                            <a class="One" href="../Merchant Cash Advance/Business Financial Services/Forms/Application/General Authorization.pdf"
