<%@ Page Language="C#" MasterPageFile="~/Payroll/Admin.master" AutoEventWireup="true" CodeFile="ResdSummary.aspx.cs" Inherits="Payroll_ResdSummary" Title="Commerce Technologies - Partner Portal" Theme="AppTheme" %>
...
<asp:Label ID="lblError" CssClass="LabelsError" EnableTheming="false" runat="server" Visible="False"></asp:Label><br />
    ...
    <asp:Panel ID="pnlConfirmation" runat="server" Visible="False" Width="750px">
        ...
        <table style="border-right: silver 1px solid; border-top: silver 1px solid; border-left: silver 1px solid;
            width: 700px; border-bottom: silver 1px solid">
            <tr>
            ...
            <tr>
                ...
                <td style="background-color: #fbfbfb">                        
                    ...
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtCarryOver"
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtCarryOver"
                        ErrorMessage="Carryover" Font-Bold="False"></asp:RequiredFieldValidator></td>
                <td style="background-color: #fbfbfb">
    ...
    <asp:Panel ID="pnlEmployees" runat="server" Visible="False" Width="700px">
                ...
                <td align="right">
                    <asp:GridView ID="grdEmployeeSummary" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="AffiliateID" HeaderText="Aff ID" />
                            <asp:BoundField DataField="Contact" HeaderText="Contact" />
                            <asp:BoundField DataField="CompanyName" HeaderText="Company">
                                <HeaderStyle Font-Names="Arial" Font-Size="Small" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ResidualPay" HeaderText="Residual Payment">
                                <HeaderStyle Font-Names="Arial" Font-Size="Small" />
                            </asp:BoundField>
                ...
                <td align="center">
                    <asp:Panel ID="pnlBPPartners" runat="server">
                        <table border="0" cellspacing="0" style="width: 700px">
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Label ID="lblFinalTotal" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small"></asp:Label></td>
                            </tr>
                        </table>
                    </asp:Panel>
                    &nbsp;</td>
