<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResdPaymentPrint.aspx.cs" Inherits="Payroll_ResdSummaryPrint" %>
...
<body style="font-size: 12pt">
    ...
    <asp:Label ID="lblMonth" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"></asp:Label><br />
        <table border="0" cellspacing="0" style="border-right: silver 1px solid; border-top: silver 1px solid;
            border-left: silver 1px solid; width: 730px; border-bottom: silver 1px solid;
            background-color: #fbfbfb">
            <tr>
            <td align="center" style="background-color:#CCCBEA;">
            ...
            <tr>
                <td align="center" style="height: 176px">
                    <asp:GridView ID="grdEmployeeSummary" runat="server" AutoGenerateColumns="False"
                        CellPadding="4" ForeColor="#333333" GridLines="Vertical" Width ="700px"
                        OnRowDataBound="grdEmployeeSummary_RowDataBound" ShowFooter="True" >
                        <FooterStyle BackColor="#EDF7FF" Font-Names="Arial" Font-Size="X-Small" Font-Bold="True" ForeColor="#284775" />
                        <Columns>
                            <asp:BoundField DataField="ResdConfirmNum" HeaderText="Confirmation" FooterStyle-Font-Size="Small" FooterText ="Sub-Totals:"/>
                        ...
                        <HeaderStyle BackColor="#565294" Font-Bold="True" Font-Names="Arial" Font-Size="10pt"
                            ForeColor="White" />
    ...
    <br />
        <center>
            ...
            <b><span style="color: #383838; font-family: Arial; font-size:small">Direct Deposit</span></b>
                ...
                <tr>
                    <td align="center">
                        <asp:GridView ID="grdSummaryDD" runat="server" AutoGenerateColumns="False"
                            CellPadding="4" ForeColor="#333333" GridLines="Vertical" Width ="700px"
                            OnRowDataBound="grdSummaryDD_RowDataBound" ShowFooter="True">
                            <FooterStyle BackColor="#EDF7FF" Font-Size="X-Small" Font-Names="Arial" Font-Bold="True" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="ResdConfirmNum" HeaderText="Confirmation" FooterStyle-Font-Size="Small" FooterText="Sub-Totals:"/>
                                <asp:BoundField DataField="ResdConfirmDate" HeaderText="Date Paid" />
                                <asp:BoundField DataField="ResdNote" HeaderText="Note" />
            ...
            <b><span style="color: #383838; font-family: Arial; font-size:small">Bill Pay</span></b>
                ...
                <tr>
                    <td align="center">
                        <asp:GridView ID="grdSummaryBP" runat="server" AutoGenerateColumns="False"
                            CellPadding="4" ForeColor="#333333" GridLines="Vertical" Width ="700px"
                            OnRowDataBound="grdSummaryBP_RowDataBound" ShowFooter="True">
                            <FooterStyle Font-Names="Arial" Font-Size="X-Small" BackColor="#EDF7FF" Font-Bold="True" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="ResdConfirmNum" HeaderText="Confirmation" FooterStyle-Font-Size="Small" FooterText="Sub-Totals:"/>
                                <asp:BoundField DataField="ResdConfirmDate" HeaderText="Date Paid" />
                                <asp:BoundField DataField="ResdNote" HeaderText="Note" />
                ...
                <tr>
                    <td align="right">
                        ...
                        <!--<td><asp:Label ID="lblBPTotal" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small"></asp:Label></td>-->
                
                <tr>
                    <td align="center" style="height: 20px">
                        <asp:Table ID="tblTotal" runat="server" CellPadding="2" CellSpacing="0" GridLines="Both" BackColor="#edf7ff" ForeColor="Black" Width="700px">
                        </asp:Table>
                    </td>
                </tr>
                <tr>
