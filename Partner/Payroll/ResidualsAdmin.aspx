<%@ Page Language="C#" MasterPageFile="~/Payroll/Admin.master" AutoEventWireup="true"
    CodeFile="ResidualsAdmin.aspx.cs" Inherits="ResidualsAdmin" Title="Commerce Technologies - Partner Portal"
    Theme="Admin" %>
                                            ...
                                            <tr>
                                                <td align="center" colspan="3" height="20px">
                                                    <asp:DropDownList ID="lstReport" runat="server">
                                                        ...
                                                        <asp:ListItem>Pivotal</asp:ListItem>
                                                        <asp:ListItem>Paya</asp:ListItem>
                                                        <%-- <asp:ListItem>CPS</asp:ListItem> --%>
                                                        <asp:ListItem Value="Chase">Card Connect</asp:ListItem>
                                                        <asp:ListItem>Merrick</asp:ListItem>
                                                        <asp:ListItem Value="MerrickDetailed">Merrick Detailed</asp:ListItem>
                                                        <asp:ListItem Value="OptimalCA">Paysafe CA</asp:ListItem>
                                                        <asp:ListItem Value="OptimalIntl">Paysafe Intl</asp:ListItem>
                                                        ...
                                                        <asp:ListItem Value="MerchantCashAdvance">Business Funding</asp:ListItem>
