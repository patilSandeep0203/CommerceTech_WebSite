<%@ Page Language="C#" MasterPageFile="~/Payroll/Admin.master" AutoEventWireup="true" CodeFile="ReferralsUpdate.aspx.cs" Inherits="ReferralsUpdate" Title="Commerce Technologies - Partner Portal" Theme="AppTheme" %>
...
<asp:Label ID="lblError" CssClass="LabelsError" EnableTheming="false" runat="server" Visible="False"></asp:Label><br />
    ...
    <table cellpadding="1" cellspacing="1" border="0" style="border-right: silver 1px solid;
        ...
        <tr>
            <td align="center" style="background-color: #565294">
