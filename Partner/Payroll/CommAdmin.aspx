<%@ Page Language="C#" MasterPageFile="~/Payroll/Admin.master" AutoEventWireup="true"
    CodeFile="CommAdmin.aspx.cs" Inherits="CommAdmin" Title="Commerce Technologies - Partner Portal"
    Theme="Admin" %>
                                        ...
                                        <tr>
                                            <td align="center" colspan="3">
                                                ...
                                                <asp:Panel ID="pnlUploadComm" runat="server" Width="90%" CssClass="DivHelp" Visible="false">
                                                    <b>Are you sure you want to upload Commissions for the current period?</b></div>
        ...
        <tr>
            <td align="center" colspan="3">
                ...
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="10px"
                    ...
                    ForeColor="Green" Text="- denotes quarter fundings"></asp:Label> -->
                <asp:HyperLink ID="lnkFundingInfo" runat="server" NavigateUrl="https://apps.commercetech.com/portal/HelpAgent.aspx#Funding" Font-Bold="True" Font-Names="Arial" Font-Size="10px" Text="Click here to view how Funded Value is calculated" ForeColor="Blue" Target="_blank"/>
            </td>
        </tr>
        <!--<tr>
            <td align="center" colspan="3">
        ...
        <asp:Panel ID="pnlFeatures" Visible="false" runat="server" Width="750px" BackColor="white">
            ...
            <asp:Panel ID="pnlGrid" runat="server" Style="border-right: silver thin solid; border-top: silver thin solid;
                ...
                <asp:GridView ID="grdComm" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <HeaderStyle BackColor="#565294" Font-Bold="True" Font-Names="Arial" Font-Size="10pt" ForeColor="White" />
                    <FooterStyle BackColor="#565294" Font-Bold="True" ForeColor="White" />
                    <Columns>
                        <asp:BoundField DataField="Mon" HeaderText="Month" SortExpression="Mon">
                            <HeaderStyle Font-Names="Arial" Font-Size="Small" BackColor="#565294" ForeColor="White"/>
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="FundedValue" HeaderText="Funded Value" />
                    </Columns>
