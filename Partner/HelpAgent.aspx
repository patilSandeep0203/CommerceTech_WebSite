...
<body>
        ...
        <a name="#00"></a>
            <div style="width: 90%">
                <asp:Panel ID="pnlAdminQs" runat="server" Width="100%" Visible="false">
                    ...
                    <div class="DivGreen" align="center"><span class="LabelsRed"><b>Funding</b></span></div>
                    <div align="left">
                        &nbsp;<img src="images/obullet.gif" height="8" width="8" border="0">
                        &nbsp;<a class="One" href="#Funding" target="_self">How is the funding calculated?</a>
                    </div>
                    <div class="DivGreen" align="center"><span class="LabelsRed"><b>Referrals</b></span></div>
                    <div align="left">
                        &nbsp;<img src="images/obullet.gif" height="8" width="8" border="0">
                        &nbsp;<a class="One" href="#Referral" target="_self">How are my referrals calculated</a>
                    </div>
                    <div class="DivGreen" align="center"><span class="LabelsRed"><b>Pricing</b></span></div>
                    <div align="left">
                        &nbsp;<img src="images/obullet.gif" height="8" width="8" border="0">
                        &nbsp;<a class="One" href="#Pricing" target="_self">What is the product pricing strategy?</a>
                    </div>
                ...
                <div align="left">
                    &nbsp;<img src="images/obullet.gif" height="8" width="8" border="0">
                    &nbsp;<a class="One" href="#ContractTerm" target="_self">What is the Service Contract Terms?</a>
                </div>
                <div align="left">
                    &nbsp;<img src="images/obullet.gif" height="8" width="8" border="0">
                    &nbsp;<a class="One" href="#CancellationRequest" target="_self">How to process Service Cancellation requests?</a>
                </div>
                <div align="left">
                    &nbsp;<img src="images/obullet.gif" height="8" width="8" border="0">
                    &nbsp;<a class="One" href="#EarlyTermination" target="_self">Service Contract Early Termination/Cancellation fees</a>
                </div>
            ...
            <tr>
                <td align="left">
                    ...
                    www.apps.commercetech.com clicking on Online Application and then View Leads. There are two options 
                    in the "Select Report Type" list on the leads page. The "Leads" option will display all the Free Report, 
                    Free Consult and Free Apply leads from www.apps.commercetech.com. The "Affiliate Signups" option displays 
                    ...
                    and fax the <a class="LinkXSmall" href="http://apps.commercetech.com/PartnerPortal/Direct%20Deposit%20Authorization%20Form.pdf">
                    ...
                    <span class="LabelsSmall">Refer to our Account Funding Criteria <a href = "https://commercetechnologies.sharepoint.com/:w:/s/Team-Meetings/EUUpA8DpnGhLmCt-3ie7jy4BSNgkmgWbfeIxnBcw8KmutA?e=khzh1t">Link</a></span>
                    <!--<ul class="LabelsSmall">
                    ...
                    <a name="ContractTerm"></a>
                    <span class="LabelsDarkBlueSmall"><b>What is Service Contract Terms?</b></span><br />
                    <span class="LabelsSmall">Most accounts can be set up on a monthly or the default standard contract term (ussually 3 years) within the online application.  
                    If the agent wishes to waive the standard contract the 1 month term must be selected in the online application and the requred form returned.  </span>
                    <br />
                    <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                    <hr noshade size="1" width="90%">

                    <a name="CancellationRequest"></a>
                    <span class="LabelsDarkBlueSmall"><b>How to process Service Cancellation requests?</b></span><br />
                    <span class="LabelsSmall">All requests received by Commerce Tech will be forwarded to the agent for possible retention.  
                    If unable to retain, it must be mentioned to the merchant that a cancellation e-mail will be sent and the form signed and returned before the account will be closed.  
                    The cancellation request must be forwarded to Jay Scott by the partner with as much detail as to why the customer wants to cancel as possible.  
                    Jay will then send the required form to the customer along with a list of reasons the customer may whish to stay with Commerce Tech and if not, the instructions to cancel.  
                    There will be no follow up from that point to nsure the customer returns the form.  
                    Additionally, we do not refund for fees billed between the time of the request and the date the account was closed.    </span>
                    <br />
                    <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                    <hr noshade size="1" width="90%">

                    <a name="EarlyTermination"></a>
                    <span class="LabelsDarkBlueSmall"><b>Service Contract Early Termination/Cancellation fees:</b></span><br />
                    <span class="LabelsSmall">It is the agents choice to enforce or waive cancellation fees for merchant accounts. 
                    If enforced, the agent will receive their commission percentage per their agreement with us.  
                    If waived, no charges will be assigned to the customer or the agent.</span>
                    <br />
                    <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                    <hr noshade size="1" width="90%">
                    ...
                    <asp:Panel ID="pnlAdminAns" runat="server" Width="100%" Visible="false">
                        ...
                        <a name="Funding"></a>
                        <span class="LabelsDarkBlueSmall"><b>How is the funding calculated?</b></span><br/>
                        <span class="LabelsSmall">
                            <table border="1" cellspacing="5" cellpadding="0">
    <tbody>
    
    <td  align="center" valign="top">Product</td>
    <td  colspan="3" align="center" valign="top"><strong><span>Funding</span></strong></td>
    </tr>
    <tr>
    <td align="left" valign="top"><span class="LabelsBody">Merchant Accounts (All except IPS)</span></td>
    <td align="center" valign="top"><span class="LabelsBody">1</span></td>
    </tr>
   
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">QuickBooks Enterprise Diamond</span></td>
        <td align="center" valign="top"><span class="LabelsBody">1</span></td>
        </tr>
    <!--<tr>
    <td align="left" valign="top"><span class="LabelsBody">QuickBooks Time Elite </span></td>
    <td align="center" valign="top"><span class="LabelsBody">$75.00</span></td>
    <td align="center" valign="top"><span class="LabelsBody">$37.50</span></td>
    </tr> -->

    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  &nbsp; </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> &nbsp;  </span></td>
    </tr>

    <tr>
    <td align="left" valign="top"><span class="LabelsBody">QuickBooks Enterprise Suite</span></td>
    <td align="center" valign="top"><span class="LabelsBody">0.75</span></td>
    </tr>
    
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">QuickBooks Enterprise Platinum</span></td>
        <td align="center" valign="top"><span class="LabelsBody">0.75</span></td>
    </tr>
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">QuickBooks Online Payroll Elite</span></td>
        <td align="center" valign="top"><span class="LabelsBody">0.75</span></td>
    </tr>
    ...
    <tr>
    <td align="left" valign="top"><span class="LabelsBody">QuickBooks Online Advanced</span></td>
    <td align="center" valign="top"><span class="LabelsBody">0.50</span></td>
    </tr>

    <tr>
    <td align="left" valign="top"><span class="LabelsBody">Merchant Account (IPS)</span></td>
    <td align="center" valign="top"><span class="LabelsBody">0.50</span></td>
    </tr>
   
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">QuickBooks Enterprise Gold</span></td>
        <td align="center" valign="top"><span class="LabelsBody">0.50</span></td>
    </tr>

    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  Quickbooks Online Payroll Premium </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> 0.50  </span></td>
    </tr>

    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  QuickBooks Time Premium </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> 0.50  </span></td>
    </tr>
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  &nbsp; </span></td>
     ...
     <tr>
     <td align="left" valign="top"><span class="LabelsBody">QuickBooks Online Plus</span></td>
     <td align="center" valign="top"><span class="LabelsBody">0.25</span></td>
    </tr>

    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  Payment Gateway </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> 0.25 </span></td>
    </tr>
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  Check Services </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> 0.25  </span></td>
    </tr>
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  Business Fundings </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> 0.25  </span></td>
    </tr>
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  QuickBooks Enterprise Silver </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> 0.25  </span></td>
    </tr>
     ...
     <tr>
    <td align="left" valign="top"><span class="LabelsBody">QuickBooks Online Essentials</span></td>
    <td align="center" valign="top"><span class="LabelsBody">0.00</span></td>
    </tr>
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  QuickBooks Online Payroll Core </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> 0.00  </span></td>
    </tr>
    <tr>
        <td align="left" valign="top"><span class="LabelsBody">  Intuit Field Service Management </span></td>
        <td align="center" valign="top"><span class="LabelsBody"> 0.00  </span></td>
    </tr>
    <tr>
    <td colspan="3" align="center" valign="top">&nbsp;</td>
                        ...
                        <br />
                        <span class="LabelsDarkBlueSmall"><a class="One" href="https://commercetechnologies.sharepoint.com/sites/Team-Meetings/Shared%20Documents/Forms/AllItems.aspx?id=%2Fsites%2FTeam%2DMeetings%2FShared%20Documents%2FGeneral%2FMisc%2FOpportunity%20Workflow%2Epdf&parent=%2Fsites%2FTeam%2DMeetings%2FShared%20Documents%2FGeneral%2FMisc&p=true&ga=1" target="_self"><b>Work Flow Chart </b></a></span><br/>
                        <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                        <hr noshade size="1" width="90%">
                        <a name="Referral"></a>
                        <span class="LabelsDarkBlueSmall"><b>How are my referrals calculated?</b></span><br />
                        <span class="LabelsSmall">
                          Click <a class="LinkXSmall" href="https://www.apps.commercetech.com/Affiliatewiz/commissions.aspx" target="_self">here</a> to view the commission schedule.
                        </span>                        
                        <br />
                        <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                        <hr noshade size="1" width="90%">
                        ...
                        <a name="Pricing"></a>
                        <span class="LabelsDarkBlueSmall"><b>What is the product pricing strategy?</b></span><br />
                        <span class="LabelsSmall">
                           <b>Products pricing strategy:<b/> 
 Usually we markup our products with 20% over the cost.<br/>
QBES (QuickBooks Enterprise Solution) pricing is fixed. You can not sell it either higher or lower amount. <br/>
Our company profit from QBES products is usually 28% of the selling price.  <br/>
There is minimum advertising price for Intuit and pcAmerica products. You can sell the products with any price but you can not advertise it.<br/>
There is one time commission fee for QuickBooks Online which is $100 that you will share it based on your percentage withe Commerce Technologies. <br/>
 Revel Payout: <br/> $240/register w/ bundle only<br/>
$600/reg w/ bundle + POS MAS (40% residual applies)<br/>
Standard $100 bounty for QBO applies to Revel attach <br/>
Verifone Payout:<br/>
10% on the hardware and 20% on the monthly software fee.<br/>
                        </span>
                        <br/>
                        <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                        <hr noshade size="1" width="90%">
