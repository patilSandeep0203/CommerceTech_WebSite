<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true"
    CodeFile="AddPartner.aspx.cs" Inherits="AddPartner" Title="Commerce Technologies - Partner Portal"
    Theme="AppTheme" %>
       ...
       <tr>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <span class="LabelsSmall">(e.g. Commerce Technologies)</span></td>
        </tr>
        <tr height="5px"></tr>     
        <tr>
            <td colspan="2" align="left">
                <asp:Panel ID="pnlRepNumbers" runat="server" Width="100%">
                    <table style="width:100%" cellpadding="0" cellspacing="2" border="0">
                        <tr>
                            <td align="right" style="width: 30%">
                                <span class="LabelsSmall">Paya Rep # Declined</span></td>
                            <td align="left">
                        ...
                        <tr>
                            <td align="right" style="width: 30%">
                                <span class="LabelsSmall">Paya</span></td>
                            <td align="left">
                                <asp:TextBox ID="txtSage" runat="server" Width="50px" TabIndex="7" MaxLength="6"></asp:TextBox>
                                <span class="LabelsSmall">Paya Rep #</span></td>
                        </tr>  
                        <tr>
                            <td align="right" style="width:30%">
                                <span class="LabelsSmall">Sales Center Username</span></td>
                            <td align="left">
                                <asp:TextBox ID="txtUnoUsername" runat="server" Width="150px" TabIndex="8" MaxLength="10"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td align="right" style="width:30%">
                                <span class="LabelsSmall">Sales Center Password</span></td>
                            <td align="left">
                        ...
                        <tr>
                            <td align="right">
                                <span class="LabelsSmall">CardConnect</span></td>
                            <td align="left">
                                <asp:TextBox ID="txtChase" Width="50px" runat="server" TabIndex="12" MaxLength="5"></asp:TextBox>
                                <span class="LabelsSmall">(CardConnect/Chase Rep #)</span></td>
                        </tr> 
                        <tr>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtResidualMin"  Width="50px" TabIndex="16" runat="server"></asp:TextBox><span class="LabelsRedLarge">*</span>
                                     <span class="LabelsSmall">(Residual Total Minimum
                                        meet Payout Requirement)</span>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtResidualMin"
                                        ErrorMessage="Residual Min">    </asp:RequiredFieldValidator></td>               
                          </tr>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <span class="LabelsSmall">(Percentage paid to rep, e.g. 35)</span></td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td align="left">
                ...
                <span class="LabelsSmall">(Percentage paid to rep)</span></td>
        </tr>
        <tr>
