                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="72%">
                            <tr><td align="left" style="height: 25px;">
                                <asp:CheckBox ID="chkCheckServices" runat="server" OnCheckedChanged="chkCheckServices_CheckedChanged"
                                    ...
                                    <asp:Image ID="imgCS" runat="server" ImageUrl="/OnlineApplication/Images/help.gif" ToolTip="Help"/>
                            </td></tr>
                            <tr><td align="left">
                            ...
                            <tr>
                                <td align="left" style="height: 25px;">
                                    <asp:CheckBox ID="chkGiftCard" runat="server" Text="Gift/Loyalty" OnCheckedChanged="chkGiftCard_CheckedChanged" AutoPostBack="true"/>
                                                                 <asp:Image ID="imgGC" runat="server" ImageUrl="/OnlineApplication/Images/help.gif" ToolTip="Help"/>    
                                    </td>
                            ...
                            <tr>
                                <td align="left" style="height: 25px;">
                                    <asp:CheckBox ID="chkMerchantFunding" runat="server" Text="Merchant Cash Advance/Business Loan" AutoPostBack="True" OnCheckedChanged="chkMCA_CheckedChanged" />                                    
                               
                               <asp:Image ID="imgMF" runat="server" ImageUrl="/OnlineApplication/Images/help.gif" ToolTip="Help"/> <br />                         
                               </td>
                            </tr> 
                            ...
                            <tr>
                                <td align="left" style="height: 25px;">
                                    <asp:CheckBox ID="chkPayroll" runat="server" Text="Payroll" AutoPostBack="True" OnCheckedChanged="chkPayroll_CheckedChanged" /> <asp:Image ID="imgPayroll" runat="server" ImageUrl="/OnlineApplication/Images/help.gif" ToolTip="Help"/>     </td>
                            </tr>
                            <tr><td style="height: 20px;" align="left">
