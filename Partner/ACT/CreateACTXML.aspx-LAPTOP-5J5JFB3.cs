...
public partial class CreateACTXML : System.Web.UI.Page
{
    ...
    public void CreateiPayAPI(System.Guid ContactID) {
        try {
        ...
        {
            CreateLog Log = new CreateLog();
            Log.ErrorLog(Server.MapPath("~/ErrorLog"), "iPaymentAPI - " + err.Message);
            DisplayMessage(err.Message);
        }
    }
    ...
    public void CreateiPayXMLNew(System.Guid ContactID)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
               ...
               //xmlAttlegalBusinessName.Value = "Test - Commerce Technologies 3";
                ...
                //xmlAttdoingBusinessAs.Value = "Test - Commerce Technologies 3";
                ...
                //xmlAttlegalBusinessName.Value = "Test - Commerce Technologies";
               ...
               // XmlAttPrincipalhowLongAtAddress.Value = "0";
                ...
                /*if (!Convert.IsDBNull(dt[0].DiscRateQualDebit))
                {

                    if (Convert.ToString(dt[0].DiscRateQualDebit) != "")
                    {
                ...
                if (!Convert.IsDBNull(dt[0].DebitRateNP))
                {
                    if (Convert.ToString(dt[0].DebitRateNP) != "")
                    {
                        XmlAttribute XmlAttdebitDiscountQualifiedFee = doc.CreateAttribute("debitDiscountQualifiedFee");
                        XmlAttdebitDiscountQualifiedFee.Value = Convert.ToString(dt[0].DebitRateNP).Trim();
                        //XmlAttdebitDiscountQualifiedFee.Value = "";
                        node.Attributes.Append(XmlAttdebitDiscountQualifiedFee);
                    }
                }
                ...
                if (!Convert.IsDBNull(dt[0].DebitRateNP))
                {
                    if (Convert.ToString(dt[0].DebitRateNP) != "")
                    {
                        ...
                        //if ((dt[0].DiscountRate.ToString().Trim() != "") && (dt[0].DiscRateMidQual.ToString().Trim() != ""))
                            XmlAttdebitDiscountMidQualifiedFee.Value = Convert.ToString(Convert.ToDouble(dt[0].DebitRateNP) + Convert.ToDouble(dt[0].DiscRateMidQual) - Convert.ToDouble(dt[0].DiscountRate));
                ...
                else if (!Convert.IsDBNull(dt[0].DiscRateQualDebit))
                {
                    if (Convert.ToString(dt[0].DiscRateQualDebit) != "")
                    {
                        XmlAttribute XmlAttdebitDiscountMidQualifiedFee = doc.CreateAttribute("debitDiscountMidQualifiedFee");
                ...
                if (!Convert.IsDBNull(dt[0].DebitRateNP))
                {
                    if (Convert.ToString(dt[0].DebitRateNP) != "")
                    {
                        ...
                        if ((dt[0].DiscountRate.ToString().Trim() != "") && (dt[0].DiscRateNonQual.ToString().Trim() != ""))
                            XmlAttdebitDiscountNonQualifiedFee.Value = Convert.ToString(Convert.ToDouble(dt[0].DebitRateNP) + Convert.ToDouble(dt[0].DiscRateNonQual) - Convert.ToDouble(dt[0].DiscountRate));
                ...
                if (!Convert.IsDBNull(dt[0].WirelessAccessFee)) 
                {
                    
                    if (Convert.ToString(dt[0].WirelessAccessFee) != "")
                    {
                        XmlAttribute XmlAttWirelessMonthlyFee = doc.CreateAttribute("WirelessMonthlyFee");
                        XmlAttribute XmlAttWirelessMonthlyFeeQuantity = doc.CreateAttribute("WirelessMonthlyFeeQuantity");
                        ...
                        //XmlAttWirelessSetupFee.Value = "0.00";
                        XmlAttWirelessMonthlyFeeQuantity.Value = "1";
                        //node.Attributes.Append(XmlAttWirelessSetupFee);
                        node.Attributes.Append(XmlAttWirelessMonthlyFee);
                        node.Attributes.Append(XmlAttWirelessMonthlyFeeQuantity);
                    }
                    else {
                        XmlAttribute XmlAttWirelessMonthlyFee = doc.CreateAttribute("WirelessMonthlyFee");
                        XmlAttribute XmlAttWirelessMonthlyFeeQuantity = doc.CreateAttribute("WirelessMonthlyFeeQuantity");
                        //XmlAttWirelessMonthlyFee.Value = Convert.ToString(dt[0].WirelessAccessFee).Trim();
                        XmlAttWirelessMonthlyFee.Value = "0.00";
                        //XmlAttWirelessSetupFee.Value = "0.00";
                        XmlAttWirelessMonthlyFeeQuantity.Value = "0";
                        node.Attributes.Append(XmlAttWirelessMonthlyFee);
                        node.Attributes.Append(XmlAttWirelessMonthlyFeeQuantity);
                    }
                ...
                if (!Convert.IsDBNull(dt[0].WirelessTransFee))
                {

                    if (Convert.ToString(dt[0].WirelessTransFee) != "")
                    {
                        XmlAttribute XmlAttWirelessPerAuthFee = doc.CreateAttribute("WirelessPerAuthFee");
                        XmlAttribute XmlAttWirelessPerAuthFeeQuantity = doc.CreateAttribute("WirelessPerAuthFeeQuantity");
                        XmlAttWirelessPerAuthFee.Value = Convert.ToString(dt[0].WirelessTransFee).Trim();
                        XmlAttWirelessPerAuthFeeQuantity.Value = "1";
                        node.Attributes.Append(XmlAttWirelessPerAuthFee);
                        node.Attributes.Append(XmlAttWirelessPerAuthFeeQuantity);
                    }
                    else {
                        XmlAttribute XmlAttWirelessPerAuthFee = doc.CreateAttribute("WirelessPerAuthFee");
                        XmlAttribute XmlAttWirelessPerAuthFeeQuantity = doc.CreateAttribute("WirelessPerAuthFeeQuantity");
                        //XmlAttWirelessPerAuthFee.Value = Convert.ToString(dt[0].WirelessTransFee).Trim();
                        XmlAttWirelessPerAuthFee.Value = "0.00";
                        XmlAttWirelessPerAuthFeeQuantity.Value = "0";
                        node.Attributes.Append(XmlAttWirelessPerAuthFee);
                        node.Attributes.Append(XmlAttWirelessPerAuthFeeQuantity);
                    }
                ...
                //Amex opt blue
                /*
                XmlAttribute XmlAttBusinessInfoVerificationFee = doc.CreateAttribute("BusinessInfoVerificationFee");
                XmlAttBusinessInfoVerificationFee.Value = "0.00";
                node.Attributes.Append(XmlAttBusinessInfoVerificationFee);

                XmlAttribute XmlAttPCIComplianceFee = doc.CreateAttribute("PCIComplianceFee");
                XmlAttPCIComplianceFee.Value = "0.00";
                node.Attributes.Append(XmlAttPCIComplianceFee);

                XmlAttribute XmlAttPCIComplianceFeeFrequency = doc.CreateAttribute("PCIComplianceFeeFrequency");
                XmlAttPCIComplianceFeeFrequency.Value = "0.00";
                node.Attributes.Append(XmlAttPCIComplianceFeeFrequency);

                XmlAttribute XmlAttMidQualPerItem = doc.CreateAttribute("MidQualPerItem");
                XmlAttMidQualPerItem.Value = Convert.ToString(dt[0].DiscRateMidQual);
                node.Attributes.Append(XmlAttMidQualPerItem);

                XmlAttribute XmlAttNonQualPerItem = doc.CreateAttribute("NonQualPerItem");
                XmlAttNonQualPerItem.Value = Convert.ToString(dt[0].DiscRateNonQual);
                node.Attributes.Append(XmlAttNonQualPerItem);

                XmlAttribute XmlAttDebitMidQualPerItem = doc.CreateAttribute("DebitMidQualPerItem");
                XmlAttDebitMidQualPerItem.Value = "0.00";
                node.Attributes.Append(XmlAttDebitMidQualPerItem);

                XmlAttribute XmlAttDebitNonQualPerItem = doc.CreateAttribute("DebitNonQualPerItem");
                XmlAttDebitNonQualPerItem.Value = "0.00";
                node.Attributes.Append(XmlAttDebitNonQualPerItem);

                XmlAttribute XmlAttterminalRentalFee = doc.CreateAttribute("terminalRentalFee");
                XmlAttterminalRentalFee.Value = "0.00";
                node.Attributes.Append(XmlAttterminalRentalFee);

                XmlAttribute XmlAttterminalRentalFeeQuantity = doc.CreateAttribute("terminalRentalFeeQuantity");
                XmlAttterminalRentalFeeQuantity.Value = "0.00";
                node.Attributes.Append(XmlAttterminalRentalFeeQuantity);

                XmlAttribute XmlAttReturnFee = doc.CreateAttribute("ReturnFee");
                XmlAttReturnFee.Value = "0.00";
                node.Attributes.Append(XmlAttReturnFee);

                XmlAttribute XmlAttTransArmorFee = doc.CreateAttribute("TransArmorFee");
                XmlAttTransArmorFee.Value = "0.00";
                node.Attributes.Append(XmlAttReturnFee);

                XmlAttribute XmlAttHasInterchangeClearingFee = doc.CreateAttribute("HasInterchangeClearingFee");
                XmlAttHasInterchangeClearingFee.Value = "0.00";
                node.Attributes.Append(XmlAttHasInterchangeClearingFee);

                XmlAttribute XmlAttInterchangeClearingFee = doc.CreateAttribute("InterchangeClearingFee");
                XmlAttInterchangeClearingFee.Value = "0.00";
                node.Attributes.Append(XmlAttInterchangeClearingFee);

                XmlAttribute XmlAttEarlyTerminationFee_BeforeFirstYear = doc.CreateAttribute("EarlyTerminationFee_BeforeFirstYear");
                XmlAttEarlyTerminationFee_BeforeFirstYear.Value = "0.00";
                node.Attributes.Append(XmlAttEarlyTerminationFee_BeforeFirstYear);

                XmlAttribute XmlAttEarlyTerminationFee_AfterFirstYear = doc.CreateAttribute("EarlyTerminationFee_AfterFirstYear");
                XmlAttEarlyTerminationFee_AfterFirstYear.Value = "0.00";
                node.Attributes.Append(XmlAttEarlyTerminationFee_AfterFirstYear);

                XmlAttribute XmlAttEarlyTerminationFee_AfterSecondYear = doc.CreateAttribute("EarlyTerminationFee_AfterSecondYear");
                XmlAttEarlyTerminationFee_AfterSecondYear.Value = "0.00";
                node.Attributes.Append(XmlAttEarlyTerminationFee_AfterSecondYear);

                XmlAttribute XmlAttInterchangePlusCreditCard = doc.CreateAttribute("InterchangePlusCreditCard");
                XmlAttInterchangePlusCreditCard.Value = "0.00";
                node.Attributes.Append(XmlAttInterchangePlusCreditCard);

                XmlAttribute XmlAttInterchangePlusOfflineDebit = doc.CreateAttribute("InterchangePlusOfflineDebit");
                XmlAttInterchangePlusOfflineDebit.Value = "0.00";
                node.Attributes.Append(XmlAttInterchangePlusOfflineDebit);

                XmlAttribute XmlAttoverlimitFee = doc.CreateAttribute("overlimitFee");
                XmlAttoverlimitFee.Value = "0.00";
                node.Attributes.Append(XmlAttoverlimitFee);

                XmlAttribute XmlAttPCINonActionFee = doc.CreateAttribute("PCINonActionFee");
                XmlAttPCINonActionFee.Value = "0.00";
                node.Attributes.Append(XmlAttPCINonActionFee);

                XmlAttribute XmlAttMonthlyRegulatoryFee = doc.CreateAttribute("MonthlyRegulatoryFee");
                XmlAttMonthlyRegulatoryFee.Value = "0.00";
                node.Attributes.Append(XmlAttMonthlyRegulatoryFee);

                XmlAttribute XmlAttRegulatoryNonComplianceFee = doc.CreateAttribute("RegulatoryNonComplianceFee");
                XmlAttRegulatoryNonComplianceFee.Value = "3.50";
                node.Attributes.Append(XmlAttRegulatoryNonComplianceFee);

                XmlAttribute XmlAttSystemProcessingFee = doc.CreateAttribute("SystemProcessingFee");
                XmlAttSystemProcessingFee.Value = "0.00";
                node.Attributes.Append(XmlAttSystemProcessingFee);*/
                ...
                XmlAttribute XmlEquipmentid = doc.CreateAttribute("EquipmentID");
                XmlEquipmentid.Value = "012a9a96-12c4-4b61-a923-0622c25cd8bb";
                node.Attributes.Append(XmlEquipmentid);

                XmlAttribute XmlProcessorid = doc.CreateAttribute("ProcessorID");
                XmlProcessorid.Value = "8f574ac9-c212-4059-bd0b-c4408e7f44da";
                node.Attributes.Append(XmlProcessorid);


                XmlAttribute XmlAttequipmentType = doc.CreateAttribute("EquipmentTypeID");
                XmlAttequipmentType.Value = "TM";
                node.Attributes.Append(XmlAttequipmentType);
                
                        if (Convert.IsDBNull(dt[0].Gateway))
                        {
                            XmlAttribute XmlAttterminalType = doc.CreateAttribute("terminalType");
                            XmlAttterminalType.Value = "1";
                            node.Attributes.Append(XmlAttterminalType);

                            XmlAttribute XmlAttterminalModel = doc.CreateAttribute("terminalModel");
                            XmlAttterminalModel.Value = "2";
                ...
                XmlAttsoftwareRequirementNotes.Value = "0";
                ...
                if (!Convert.IsDBNull(dt[0].Gateway))
                {
                    if (Convert.ToString(dt[0].Gateway) != "")
                    {
                        ...
                        XmlNodeList nodelistParent = doc.GetElementsByTagName("Software");
                        //Create another Principal node <Principal> with the same tag names for principal 1.
                        parentNode = nodelistParent.Item(0);
                ...
                //after 0914 version
                /*
                    XmlAttribute XmlAttAmexcreditCardQualifiedFee = doc.CreateAttribute("creditCardQualifiedFee");
                    XmlAttAmexcreditCardQualifiedFee.Value = "";
                    node.Attributes.Append(XmlAttAmexcreditCardQualifiedFee);

                    XmlAttribute XmlAttAmexcreditCardMidQualifiedFee = doc.CreateAttribute("creditCardMidQualifiedFee");
                    XmlAttAmexcreditCardMidQualifiedFee.Value = "";
                    node.Attributes.Append(XmlAttAmexcreditCardMidQualifiedFee);

                    XmlAttribute XmlAttAmexcreditCardNonQualifiedFee = doc.CreateAttribute("creditCardNonQualifiedFee");
                    XmlAttAmexcreditCardNonQualifiedFee.Value = "";
                    node.Attributes.Append(XmlAttAmexcreditCardNonQualifiedFee);

                    XmlAttribute XmlAttAmexuseDiscountInterchange = doc.CreateAttribute("useDiscountInterchange");
                    XmlAttAmexuseDiscountInterchange.Value = "";
                    node.Attributes.Append(XmlAttAmexuseDiscountInterchange);

                    XmlAttribute XmlAttAmexuseErr = doc.CreateAttribute("useErr");
                    XmlAttAmexuseErr.Value = "";
                    node.Attributes.Append(XmlAttAmexuseErr);

                    XmlAttribute XmlAttAmexerrRate = doc.CreateAttribute("errRate");
                    XmlAttAmexerrRate.Value = "";
                    node.Attributes.Append(XmlAttAmexerrRate);

                    XmlAttribute XmlAttAmexAmexDirect = doc.CreateAttribute("AmexDirect");
                    XmlAttAmexAmexDirect.Value = "";
                    node.Attributes.Append(XmlAttAmexAmexDirect);*/
                ...
                /*XmlAttribute XmlAttCardAcceptanceAmericanExpressCredit = doc.CreateAttribute("AmericanExpressCredit");
                XmlAttCardAcceptanceAmericanExpressCredit.Value = "false";
                node.Attributes.Append(XmlAttCardAcceptanceAmericanExpressCredit);*/
                ...
                System.Xml.XmlDocument xmlResult1 = new System.Xml.XmlDocument();

                //string strTestPath1 = Server.MapPath("test1.xml");
                //xmlResult1.Save(result);
                        ...
                        else
                        {
                            ...
                            if ((Convert.ToInt32(strAppID) != 0) && (Convert.ToInt32(strErrorCount) == 0))
                            {
                                ...
                                catch (Exception err)
                                {
                                    ...
                                    Log1.ErrorLog(Server.MapPath("~/ErrorLog"), "iPaymentXML1 - " + err.Message);
                                }
                            }
                        }
    ...
    public string SubmitIpayXml(string strAppID)
    {
        ...
        try
        {
            ...
            SubmitResults.Append("<ApplicationSubmitRequest xmlns=\"https://ipaymentinc.com/MerchantApplications/20110105\">");
            ...
            //string submitUrl = "https://localhost/datafeeds/Services/v1_0/MerchantApplication.svc/xml/{}/SubmitApplication?apitoken={}&usertoken={}";
            ...
            CreateLog Log111 = new CreateLog();
            Log111.ErrorLog(Server.MapPath("~/ErrorLog"), "iPaymentXMLTest - " + submitUrl);
    ...
    public string ValidateSaveiPay(string xmlRequest)
    {
        ...
        try
        {
            string URLString = "https://api.ipaymentinc.com/merchantapplications?apitoken=3DB65AAE-70F6-11E0-B698-4DE54724019B&usertoken=9028BB7E-F20F-11E1-A924-663B6288709B";
    ...
    public void CreateiPayXML(System.Guid ContactID)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //string strMachineName = "www.apps.commercetech.com/PartnerPortal";
    ...
    public string UploadSageXML(System.Guid ContactID)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (dt[0].LegalStatus.ToString().Trim().Contains("Corporation"))
                appInfo.CorpTypeID = 20; //C-Corp type
           ...
           // appInfo.LegalName = dt[0].LegalName.ToString().Trim();
            ...
            if (!Convert.IsDBNull(dt[0].P2OwnershipPercent))
            {
                if (Convert.ToString(dt[0].P2OwnershipPercent).Trim() != "")
                {
                    if (Convert.ToInt16(dt[0].P1OwnershipPercent) + Convert.ToInt16(dt[0].P2OwnershipPercent) == 100)
                    {
                        appInfo.Owner1Equity = dt[0].P1OwnershipPercent.ToString().Trim();
                    }
                    else
                    {
                        appInfo.Owner1Equity = Convert.ToString(100 - Convert.ToInt16(dt[0].P1OwnershipPercent));
                    }
                }
                else
                { 
                    appInfo.Owner1Equity = "100"; 
                }
            }
            else
            {
            ...
            if (dt[0].Interchange.ToString().Trim().ToLower() == "true")
            {
                ...
                bi[3].CardTypeID = 3;  // amex
                bi[3].DiscountQualifiedRate = Convert.ToDouble(dt[0].DiscountRate.ToString().Trim());
                bi[3].DiscountCheckcardRate = Convert.ToDouble(dt[0].DiscountRate.ToString().Trim());
                bi[3].BetInterchangeID = "4598"; //BET#
            }
            ...
            else if (Convert.ToDecimal(dt[0].CPSwiped.ToString().Trim()) >= 70)
            {
                ...
                decimal midQualStep = Convert.ToDecimal(Convert.ToString(dt[0].DiscRateMidQual).Trim()) - Convert.ToDecimal(Convert.ToString(dt[0].DiscountRate).Trim());
                decimal nonQualStep = Convert.ToDecimal(Convert.ToString(dt[0].DiscRateNonQual).Trim()) - Convert.ToDecimal(Convert.ToString(dt[0].DiscountRate).Trim());
                
                if ((midQualStep == 1m) && (nonQualStep == 2m))
                {   
                    bi[0].BetInterchangeID = "7534"; 
                    bi[1].BetInterchangeID = "5534"; 
                    bi[2].BetInterchangeID = "3427";
                    bi[3].BetInterchangeID = "4708";
                ...
                } else if ((midQualStep == 0.8m) && (nonQualStep == 2.05m))
                {
                    ...
                    bi[3].BetInterchangeID = "4555"; //"4598" - old bets 0.8/1.9 //BET#
                }

                else if ((midQualStep == 1m) && (nonQualStep == 1.5m))
                {
                    bi[0].BetInterchangeID = "7286"; //BET# MidQualStep = 1.00, NonQualStep = 1.5
                    bi[1].BetInterchangeID = "5286"; //BET#
                    bi[2].BetInterchangeID = "3099"; //BET#
                    bi[3].BetInterchangeID = "4597"; //BET#
                }

                else if ((midQualStep == 0.5m) && (nonQualStep == 1m))
                {
                    bi[0].BetInterchangeID = "7282"; //BET# MidQualStep = 0.50, NonQualStep = 1.00
                    bi[1].BetInterchangeID = "5282"; //BET#
                    bi[2].BetInterchangeID = "3085"; //BET#
                    bi[3].BetInterchangeID = "4193"; //BET#
                }
                else if ((midQualStep == 0.72m) && (nonQualStep == 1.67m))
                {
                    ...
                    bi[3].BetInterchangeID = "4513"; //BET#
                }
                else if ((midQualStep == 0.00m) && (nonQualStep == 0.00m))
                {
                    bi[0].BetInterchangeID = "7291"; //BET# MidQualStep = 0.00, NonQualStep = 0.00
                    bi[1].BetInterchangeID = "5291"; //BET#
                    bi[2].BetInterchangeID = "3191"; //BET#
                    bi[3].BetInterchangeID = "4192"; //BET#
                }
                else
                    return "Non standard BETs have been used. Please resubmit with one of the following combinations of MidQualSteps and NonQualSteps: 0.80, 2.05; 1.00, 1.50; 0.50, 1.00;" + 
                        System.Environment.NewLine + "find a BET table that match the rates on the application; or if none match, submit a request to RM for creation of a new BET table and forward to support@commercetech.com to add to the secondary BET list.";
            ...
            else
            {
                ...
                if ((midQualStep == 1m) && (nonQualStep == 2m))
                {
                    bi[0].BetInterchangeID = "8455"; //
                    bi[1].BetInterchangeID = "6455"; //
                    bi[2].BetInterchangeID = "3418"; //
                    bi[3].BetInterchangeID = "4464"; //
                }
                else if ((midQualStep == 0.8m) && (nonQualStep == 2.05m))
                {
                    ...
                    bi[3].BetInterchangeID = "4438"; //"4598" - old bets 0.8/1.9 //BET#
                }

                else if ((midQualStep == 1m) && (nonQualStep == 1.5m))
                {
                    bi[0].BetInterchangeID = "8155"; //BET# MidQualStep = 1.00, NonQualStep = 1.5
                    bi[1].BetInterchangeID = "6155"; //BET#
                    bi[2].BetInterchangeID = "3282"; //BET#
                    bi[3].BetInterchangeID = "4458"; //BET#
                }

                else if ((midQualStep == 0.5m) && (nonQualStep == 1m))
                {
                    bi[0].BetInterchangeID = "8151"; //BET# MidQualStep = 0.50, NonQualStep = 1.00
                    bi[1].BetInterchangeID = "6151"; //BET#
                    bi[2].BetInterchangeID = "3074"; //BET#
                    bi[3].BetInterchangeID = "4266"; //BET#
                }
                else if ((midQualStep == 0.72m) && (nonQualStep == 1.67m))
                {
                    ...
                    bi[3].BetInterchangeID = "4430"; //BET#
                }
                else if ((midQualStep == 0.00m) && (nonQualStep == 0.00m))
                {
                    bi[0].BetInterchangeID = "8693"; //BET# MidQualStep = 0.00, NonQualStep = 0.00
                    bi[1].BetInterchangeID = "6693"; //BET#
                    bi[2].BetInterchangeID = "3192"; //BET#
                    bi[3].BetInterchangeID = "4649"; //BET#
                }
                else
            ...
            mf[1].Amount = Convert.ToDouble(0);
            // support 
            //we don't charge a separate support fee
            mf[2] = new clsMerchFeeV1();
            mf[2].MerchFeeItemID = 20;
            mf[2].Amount = Convert.ToDouble(dt[0].CustServFee.ToString().Trim()); 
            ...
            if (!Convert.IsDBNull(dt[0].WirelessAccess))
            {
            ...
            // credit application fee - we don't track this
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Page.IsValid)
            {
                ...
                PartnerDS.OnlineAppSummaryDataTable dtUnsync;
                OnlineAppSummaryBL Summary = new OnlineAppSummaryBL();

                string strToDate = DateTime.Today.Date.Month + "/" + DateTime.Today.Date.Day + "/" + DateTime.Today.Date.Year;
                dtUnsync = Summary.GetSummary("ALL", "ALL", "1/1/1999", strToDate, "App ID", true);

                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (dtUnsync.Rows.Count > 0)
                    {
                        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            DataRow dr = ds.Tables[0].Rows[0];

                            if (!Convert.IsDBNull(dr["AppID"]))
                            {
                                if (Convert.ToString(dr["AppID"]) != "")
                                {
                                    //if Convert.ToString(dtUnsync)
                                    for (int j = 0; j < dtUnsync.Rows.Count; j++)
                                    {
                                        if (Convert.ToString(dtUnsync[j].AppId).Trim() == Convert.ToString(dr["AppID"]).Trim())
                                        {
                                            DisplayMessage("Application unsynched: AppId: " + Convert.ToString(dr["AppID"]).Trim() + ". ");
                                            grdPDF.Visible = true;
                                            grdPDF.Enabled = false;
