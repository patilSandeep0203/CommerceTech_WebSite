<%@ Page Language="C#" MasterPageFile="~/ACT/MasterPage/Admin.master" AutoEventWireup="true" CodeFile="Copy of CreateACTXML.aspx.cs"
    Inherits="CreateACTXML" Title="Commerce Technologies - Partner Portal" Theme="AppTheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 300px;" class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="height: 25px; background-color: #565294;">
