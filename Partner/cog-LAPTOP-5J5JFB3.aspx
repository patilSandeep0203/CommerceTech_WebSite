<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="cog.aspx.cs"
    Inherits="cog" Title="Commerce Technologies - Partner Portal" Theme="AppTheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Label ID="lblError" CssClass="LabelsError" EnableTheming="false" runat="server" Visible="False"></asp:Label><br />
        ...
        <tr>
            <td align="center" colspan="2" style="background-color: #565294;;
                height: 25px">
        ...
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="lstSelectType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="lstSelectType_SelectedIndexChanged">
                    ...
                    <asp:ListItem Value="Non-inventory" Text="Non-inventory"></asp:ListItem>
    ...
    <asp:UpdatePanel ID="UpdatePanelCOG" runat="server">
        <ContentTemplate>
			...
			<asp:Panel ID="pnlAddProduct" runat="server" Visible="False">
				<span class="LabelsRedSmall"><strong>If applicable, also add product to the store.</strong></span>
				<table style="width: 100%" class="DivGreen">
					<tr>
						<td style="background-color: #565294;;">
						...
						<td style="background-color: #565294;">
						<strong><span class="MenuHeader">Product Code</span></strong></td>
						<td style="background-color: #565294;">
					...
					<tr>
						...
						<asp:DropDownList ID="lstType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="lstType_SelectedIndexChanged">
                            ...
                            <asp:ListItem  Value="Non-inventory" Text="Non-Inventory">
							</asp:ListItem>
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtProstoresCode" ErrorMessage="Store Code">
						</asp:RequiredFieldValidator>
						</td>
						<td valign="top" style="height: 28px">
			...
			<asp:Panel ID="pnlUpdate" runat="server" Visible="False">
				<span class="LabelsRedSmall"><strong>Sell Price and Sell Description will be updated
                    in the Firstaffiliates website. If applicable, also update in the store.</strong></span>
				<table style="width: 100%" class="DivGreen">
					<tr>
						<td style="background-color: #565294;">
						...
						<strong><span class="MenuHeader">Website Display</span></strong></td>
						<td style="background-color: #565294;">
						<strong><span class="MenuHeader">Store Code</span></strong></td>
						<td style="background-color: #565294;">
						<strong><span class="MenuHeader">Image Name</span></strong></td>
						<td style="background-color: #565294;">
						<strong>
					...
					<tr>
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtUpdateProstoresCode" ErrorMessage="Store Code">
						</asp:RequiredFieldValidator>
						</td>
						<td valign="top">
			...
			<asp:GridView ID="grdCOG" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Vertical" OnRowCommand="grdCOG_RowCommand" OnRowDeleting="grdCOG_RowDeleting" OnRowDataBound="grdCOG_RowDataBound" Width="100%">
				...
				<Columns>
					...
					<asp:imagefield DataImageUrlField="ImageURL" DataImageUrlFormatString="https://www.apps.commercetech.com/Affiliatewiz/Images/ProductImages/{0}" HeaderText="Image" ControlStyle-Width="50px">
					</asp:imagefield>
					...
					<asp:hyperlinkfield DataNavigateUrlFields="ProstoresCode" DataNavigateUrlFormatString="http://store.commercetech.com/cart.php?action=add&product_id={0}" HeaderText="Buy" NavigateUrl="http://www.commercetech.com/Cart.bok" Target="_blank" Text="Buy">
