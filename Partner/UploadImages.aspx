<%@ Page Language="c#" AutoEventWireup="false" Inherits="netimageupload.uploadfiles"
    Title="Commerce Technologies - Partner Portal" Theme="AppTheme" CodeFile="UploadImages.aspx.cs" %>
...
<body>
    <form id="Form1" method="post" runat="server" enctype="multipart/form-data">
        <table style="width: 600px" class="SilverBorder" align="center">
            <tr>
                <td align="center" style="background-color: #565294;; height: 25px" colspan="2">
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnUpload" runat="server" Text="Upload" Width="100px" Height="50px"></asp:Button>
                </td>
            </tr>
            <tr>
                <td></td>
