<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetBounds.aspx.cs" Inherits="SetBounds" Title="Commerce Technologies - Partner Portal"
    Theme="AppTheme" %>
   ...
   <cc1:TabContainer runat="server" ID="Tabs"> 
        <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="Processor Minuimums"> 
            <ContentTemplate>
                ...
                <table align="center"  cellpadding="0" cellspacing="0" border="0" style="width: 950px;" class="DivGreen">
                    <tr>
                    ...
                    <tr>
                        <td align="center" colspan="8">
                            ...
                            <!--This is where I need to add the Billing Method dropdown-->
                                                <asp:DropDownList ID="lstRateNames" runat="server" AutoPostBack="True"  TabIndex="1">
                                ...
                                <tr style="height: 24px;">
                                    ...
                                    <td align="right">
                                        ...
                                        <td align="left">
                                            ...
                                            <span class="LabelsSmall">%</span></td>
                                        <td align="right" style="height: 30px; width: 120px;">
                                            <asp:Label ID="Label23" runat="server" Text="Amex Disc Qual"></asp:Label>&nbsp;</td>
                                    ...
                                    <!-- Mid Qual-->
                                    <td align="right">
                                        <span class="LabelsSmall">Mid Qual</span>&nbsp;
                                    </td>
                                    <td align="left">
                                    ...
                                    <td align="right">
                                        <asp:Label ID="lblDRMQ" runat="server" Text=""></asp:Label>&nbsp;
                                    </td>
                                    <td align="left">
                                    ...
                                    <td align="right" style="display:none;">
                                        ...
                                        <td align="left" style="display:none;">
                                            ...
                                            <td align="right" style="height: 30px; width: 120px;">
                                            <asp:Label ID="Label3" runat="server" Text="Amex Disc Mid Qual"></asp:Label>&nbsp;</td>
                                        <td align="left" style="height: 24px">
                                    ...
                                    <!-- Stop Here!!!! -->
                                        <td align="right">
                                            <span class="LabelsSmall">Non Qual</span>&nbsp;
                                        </td>
                                        <td align="left">
                                        ...
                                        <td align="right">
                                            <asp:Label ID="lblDRNQ" runat="server" Text=""></asp:Label>&nbsp;
                                        </td>
                                        <td align="left">
                                            ...
                                            <td align="right" style="height: 30px; width: 120px;">
                                            <asp:Label ID="Label26" runat="server" Text="Amex Disc Non Qual"></asp:Label>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td align="right" style="height: 22px" colspan="5">
                                                        </td>
                                                        <td align="left" style="height: 22px">
                                                        </td>
                                        <td align="right">
                                            <asp:Label ID="Label2" runat="server" Text="Regulatory Fee"></asp:Label>&nbsp;</td>
                                        <td align="left">
                                        <span class="LabelsSmall">$</span>
                                            <asp:TextBox ID="txtComplianceFee" runat="server" Width="40px" TabIndex="5" MaxLength="6"></asp:TextBox>
                                            </td>
                                        <td align="left">
                                        </td>
                                        <td align="right">
                                                        ...
                                                        <td align="center" colspan="4">
                                                            <asp:Panel ID="pnlOnlineDebit" runat="server" Visible="true" Width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="2">
                                                                    ...
                                                                    <tr>
                                                                    <td align="right">
                                                                            <asp:Label ID="lblDebitDiscount" runat="server" Text="Debit Discount"></asp:Label></td>
                                                                        <td align="left">
                                                                            <span class="LabelsSmall">$</span>
                                                                            <asp:TextBox ID="txtPinDebitDiscount" runat="server" MaxLength="5" TabIndex="22" Width="40px"></asp:TextBox></td>
                                                                        <td align="right">
