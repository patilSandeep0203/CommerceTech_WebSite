                    ...
                    <ContentTemplate>
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <table cellpadding="0" align="center" cellspacing="0" border="0" style="width: 900px;"
                                    class="DivGreen">
                                    <tr>
                                        <td colspan="10" align="center" style="height: 25px; background-image: url(../Images/topMain.gif)">
                                    ...
                                    <tr>
                                        <td align="center" colspan="10" style="height: 15px">
                                    ...
                                    <tr>
                                        <td style="height: 15px" colspan="12">
                                        </td>
                                    </tr>
                                    <tr>
                                               ...
                                               <asp:TextBox ID="txtQualNPDebit" runat="server" Width="40px" TabIndex="8" MaxLength="6"  AutoPostBack="true"></asp:TextBox>
                                                ...
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender29" runat="server" TargetControlID="txtQualNPDebit"
                                                    FilterType="Custom, Numbers" ValidChars="." />
                                                        ...
                                                        <td align="right" style="width: 131px; height: 24px; display:none;">
