                        ...
                        <asp:Panel ID="pnlRepNumbers" runat="server" Width="100%">
                            <table style="width:100%" cellpadding="0" cellspacing="2" border="0"> 
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtiPay1" runat="server" ReadOnly="True" Width="50px" MaxLength="5" Enabled="false"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtiPay2" runat="server" ReadOnly="True" Width="50px" MaxLength="5" Enabled="false"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtIMS" runat="server" ReadOnly="True" Width="50px" MaxLength="5" Enabled="false"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtIMSQB" runat="server" Width="50px" MaxLength="5" Enabled="false"></asp:TextBox>
