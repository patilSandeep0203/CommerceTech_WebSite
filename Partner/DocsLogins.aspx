0<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="DocsLogins.aspx.cs"
                ...
                <span class="MenuHeader"><strong>Services</strong></span></td>
                    ...
                    <tr>
                        <td style="height: 15px">
                            <a class="One" href="https://commercetechnologies.sharepoint.com/:x:/s/Sales/EU9am5P7M8NBhH19MdDYwnYBM0h82yPrByghd9t6v8pe-g?e=cKCfeR" target="_blank">
                                Rate Comparison Template - 3 Tier</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 15px">
                            <a class="One" href="https://commercetechnologies.sharepoint.com/:x:/s/Sales/ES0as37BBFhPsvKvfPwn8C0BYbJtXp4hx_eo8BH64J9bEg?e=jmMJRX"
                    ...
                    <tr>
                        <td style="height: 15px">
                            <a class="One" href="https://commercetechnologies.sharepoint.com/:x:/s/Sales/Edh17MzqMk5MgxFcfYmQay0B7OBtumsiN4jmzg8XnKI_jg?e=U048ta"
                                target="_blank">Rate Comparison Template - Flat Rate</a>
                        </td>
                    </tr>
                    <!--<tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://qsp.intuit.com" target="_blank">Intuit QSP Partner Portal</a></td>
                    </tr>
...
" target="_blank">Price Sheet</a></td>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>
                                <a class="One" href="https://partner.nuvei.com/apophis/home" target="_blank">Nuvei/Pivotal Live</a></td>
                        </tr>
                ...
                <table border="0" cellspacing="2" style="width: 95%;" class="SilverBorder">
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://quickbooks.intuit.com/partners/irp/payroll/?cid=irp-75"
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://quickbooks.intuit.com/partners/irp/qbtime/?cid=irp-75"
                                target="_blank">QuickBooks Time Signup</a></td>
                    </tr>
                    <!--<tr>
                        <td>
            ...
            <td style="height: 25px; background-color: #918EB9;" valign="middle" align="center" class="BorderBlack">
                <span class="MenuHeader"><strong>Software</strong></span></td>
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://www.clover.com/appmarket"
                                target="_blank">Market Place</a>
                        </td>
                    </tr>
                   ...
                   <tr>
                    ...
                    <tr>
	                    <td style="background-image: url('Images/homeback.gif');" class="SilverBorder">
	                    <b><span class="LabelsRed">QuickBooks Online</span></b></td>
                    </tr>
                    <tr>
                        <td>
                            <a class="One" href="https://quickbooks.intuit.com/partners/irp/qbo/?cid=irp-75" target="_blank">QuickBooks Online Signup</a></td>
                    </tr>
                    ...
                    <tr>
	                    <td style="background-image: url('Images/homeback.gif');" class="SilverBorder">
	                    <b><span class="LabelsRed">Webgility</span></b></td>
                    </tr>
                    <tr>
	                    <td>
		                    <a class="One" href="https://www.webgility.com/refer-a-lead"
		                    target="_blank">Webgility Lead form</a>
	                    </td>
                    </tr>
                    <!--<tr>
                        <td>
            ...
            <td style="height: 25px; background-color: #918EB9;" valign="middle" align="center" class="BorderBlack">
                <span class="MenuHeader"><strong>Hardware</strong></span></td>
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://www.pax.us/knowledge-base/" target="_blank">PAX Knowledge Base</a></td>
                    </tr>
 ...
 <tr>
            ...
            <td valign="top" align="center" width="33%">
                ...
                <table border="0" cellspacing="2" style="width: 95%;" class="SilverBorder">
                    ...
                    <tr>
                        <td>
                            <a class="One" href="https://commercetechnologies.sharepoint.com/:b:/s/IT2/EZniaBfso4BIjMCNC6hbxcoBgcJclMav3F1oRo_gxh_q_Q?e=vL9s3A"
                ...
                <table border="0" cellspacing="2" style="width: 95%;" class="SilverBorder">
                    ...
                    <tr>
                        <td>
                            <asp:HyperLink ID="Webgilitylink11" runat="server" CssClass="One" NavigateUrl="https://www.webgility.com/refer-a-lead"
