...
//]]></script>
<script language="JavaScript" type="text/javascript">
    TrustLogo("https://sectigo.com/images/seals/sectigo_trust_seal_md_2x.png", "SECOV", "none");
</script>
                        ...
                        <tr>
                            <td align="center" colspan="1">
                                <table style="width: 90%; border-right: silver 1px solid; border-top: silver 1px solid;
                                    ...
                                    <tr>
                                        <td align="center">
                                            <strong><span style="font-size: Medium; color: #064787; font-family: Arial"></span></strong> <span style="font-size: smaller;
                                        ...
                                        <tr>
                                            <td align="center" valign="middle">
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center" colspan="2" style="height: 44px;" valign="middle">
                                                            <strong><span style="color: #194390">
                                                                <asp:Label ID="lblHeader" Font-Names="Arial" Font-Size="small" runat="server" Text="Please provide your Portal Login Name and Password"></asp:Label></span></strong></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td valign=top align=left><span style="font-family: Arial; font-size:8pt;">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <tr>                                                       
                                                            <td align="right" style="height: 20px" valign=baseline>
                                                                <asp:Label ID="lblPassphrase" runat="server" Text="Retrieve password?" Font-Names="Arial" Font-Size="Small"></asp:Label></td>
                                                    ...
                                                    <tr>                                                       
                                                            <td align="right" style="height: 20px" valign=baseline>
                                                                <asp:Label ID="Label1" runat="server" Text="Email" Font-Names="Arial" Font-Size="Small"></asp:Label></td>
                                                            <td align="left" style="height: 20px" valign="middle">&nbsp;
