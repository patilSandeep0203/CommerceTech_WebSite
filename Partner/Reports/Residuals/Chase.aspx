<%@ Page Language="C#" MasterPageFile="~/Reports/Admin.master" AutoEventWireup="true" CodeFile="Chase.aspx.cs" Inherits="Residuals_Chase" Title="Commerce Technologies - Partner Portal" Theme="Admin" EnableEventValidation="false" %>
...
<asp:Label ID="lblError" CssClass="LabelsError" EnableTheming="false" runat="server" Visible="False"></asp:Label><br />
    <asp:Label ID="Label1" CssClass="LabelsError" EnableTheming="false" runat="server" Visible="False"></asp:Label><br />
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 260px;" class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="height: 25px; background-image: url(/PartnerPortal/Images/topMain.gif)">
                <b><span class="MenuHeader">CardConnect
    ...
    <asp:Table ID="tblResidualsNew" runat="server" CellPadding="2" CellSpacing="0" GridLines="Both">
    </asp:Table>
    <br />
