<%@ Page Language="C#" MasterPageFile="~/Reports/Admin.master" AutoEventWireup="true" CodeFile="CTCart.aspx.cs" Inherits="Residuals_CTCart" Title="Commerce Technologies - Partner Portal" Theme="Admin" EnableEventValidation="false"%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 260px;" class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="height: 25px; background-image: url(/PartnerPortal/Images/topMain.gif)">
                <b><span class="MenuHeader">CTCart Residual Reports</span></b></td>
        </tr>
        <tr>
            <td>
                <cc1:TabContainer runat="server" ID="Tabs" CssClass="ajax__tab_CSS">
                    ...
                    <cc1:TabPanel ID="TabPanelLookup" runat="server" HeaderText="Lookup by Domain">
                        <ContentTemplate>
                                ...
                                <tr>
                                    <td align="right" style="width:50%">
                                        <asp:Label ID="lblLookUpBy" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                                            ForeColor="#383838" Text="Lookup By Domain"></asp:Label>&nbsp;</td>
