<%@ Page Language="C#" MasterPageFile="~/Reports/Admin.master" AutoEventWireup="true" CodeFile="IPS.aspx.cs" Inherits="Residuals_IPS" Title="Commerce Technologies - Partner Portal" Theme="Admin" EnableEventValidation="false" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 260px;" class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="background-image: url(/PartnerPortal/Images/topMain.gif);
                height: 25px">
                <b><span class="MenuHeader">IPS Residual Reports</span></b></td>
        </tr>
        <tr>
            <td>
