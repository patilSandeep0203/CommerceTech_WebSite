<%@ Page Language="C#" MasterPageFile="~/Reports/Agent.master" AutoEventWireup="true" CodeFile="TierResiduals.aspx.cs" Inherits="Reports_Residuals_TierResidual" Title="Commerce Technologies - Partner Portal" Theme="Admin" EnableEventValidation="false" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 300px;" class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="height: 25px; background-image: url(/PartnerPortal/Images/topMain.gif)">
                <b><span class="MenuHeader">Commerce Technologies Tier
