<%@ Page Language="C#" MasterPageFile="~/Reports/Admin.master" AutoEventWireup="true" CodeFile="Copy (2) of ActivatedResd.aspx.cs" Inherits="Residuals_ActivatedResd" Title="Commerce Technologies - Partner Portal" Theme="AppTheme" %>
    ...
    <table style="width: 260px;" cellspacing="0" cellpadding="0" border="0" class="SilverBorder">
        <tr>
            <td style="background-image: url(/PartnerPortal/Images/topMain.gif); height: 25px" align="center"
                colspan="3">
                <b><span class="MenuHeader">Activated Residuals</span></b></td>
        </tr>
        <tr>
