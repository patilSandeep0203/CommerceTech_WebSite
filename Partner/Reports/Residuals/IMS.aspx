<%@ Page Language="C#" MasterPageFile="~/Reports/Admin.master" AutoEventWireup="true"
    CodeFile="IMS.aspx.cs" Inherits="Residuals_IMS" Title="Commerce Technologies - Partner Portal"
    Theme="Admin" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 260px;" class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="background-image: url(/PartnerPortal/Images/topMain.gif);
                height: 25px">
                <b><span class="MenuHeader">IMS Residual Reports</span></b></td>
        </tr>
        <tr>
            <td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tr>
                                    <td align="right" style="width: 50%">
                                        <asp:Label ID="lblSelectRepName" runat="server" Font-Bold="True" Font-Names="Arial"
                                            Font-Size="8pt" Text="Select Rep Name"></asp:Label>&nbsp;
                                    </td>
                                ...
                                <tr>
                                    <td align="right" style="width: 50%">
                                        <asp:Label ID="lblLookUpBy" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="8pt"
                                            ForeColor="#383838" Text="Look up By DBA"></asp:Label>&nbsp;</td>
    ...
    <asp:Table ID="tblResiduals" runat="server" CellPadding="2" CellSpacing="0"
        GridLines="Both" Width="500px">
    </asp:Table>
</asp:Content>
