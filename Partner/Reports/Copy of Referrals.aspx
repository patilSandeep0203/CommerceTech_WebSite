<%@ Page Language="C#" MasterPageFile="~/Reports/Employee.master" AutoEventWireup="true" CodeFile="Referrals.aspx.cs" Inherits="Referrals" Title="Commerce Technologies - Partner Portal" Theme="Admin" %>
...
<asp:Label ID="lblError" CssClass="LabelsError" EnableTheming="false" runat="server" Visible="False"></asp:Label><br />
    ...
    <br/>  
    <table cellpadding="2" cellspacing="2" border="0" style="width: 700px;" class="DivGreen">
        <tr>
            <td align="left">
        ...
        <tr>
            <td align="left">
                <span class="Labels">1. 
                    Full payment received including lease funding
                        received prior to cutoff date for all POS sales, application fees and other setup
                        costs.</span></td>
        </tr>
        <tr>
            <td align="left">
                <span class="Labels">2. 
                    All merchant numbers including non bankcard
                        that the customer wants have been issued and programmed in to equipment or software.</span>
                    <br />
        ...
        <tr>
            <td align="left">
                <span class="Labels">3.
                    Startup letter and any labels for equipment
                        we did not have to ship has been e-mailed, mailed or faxed.</span></td>
        </tr>
        <tr>
            <td align="left">
                <span class="Labels">4. 
                    The customer has received their equipment
                        and any additional services that are part of the sale have been activated and tested
                        upon it.</span></td>
        </tr>
        <tr>
            <td align="left">
                <span class="Labels">5. 
                    If a payment gateway is sold, the merchant
                        has completed the login of the gateway and all requested card types are active.</span>
                        </td>
        </tr>
        <tr>
            <td align="left">
                <span class="Labels">6. 
                    Lastly, the merchant is happy and expects
                        nothing else to be completed.</span></td>
        </tr>
    </table>
</asp:Content>
