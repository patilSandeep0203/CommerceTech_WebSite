<%@ Page Language="C#" MasterPageFile="~/Reports/Employee.master" AutoEventWireup="true" CodeFile="CTCSalesOpps.aspx.cs" Inherits="CTCSalesOpps" Title="Commerce Technologies - Partner Portal" Theme="Admin" %>
...
<asp:Label ID="lblError" CssClass="LabelsError" EnableTheming="false" runat="server" Visible="False"></asp:Label><br />
    ...
    <asp:HyperLink ID="lnkEmail" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small"
        NavigateUrl="mailto:accounting@commercetech.com">accounting@commercetech.com</asp:HyperLink></asp:Panel>
