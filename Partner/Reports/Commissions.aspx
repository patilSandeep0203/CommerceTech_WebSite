<%@ Page Language="C#" MasterPageFile="~/Reports/Employee.master" AutoEventWireup="true" CodeFile="Commissions.aspx.cs" Inherits="Commissions" Title="Commerce Technologies - Partner Portal" Theme="Admin" %>
...
<asp:Label ID="lblError" CssClass="LabelsError" EnableTheming="false" runat="server" Visible="False"></asp:Label><br />
    ...
    <table border="0" cellpadding="2" cellspacing="2" style="width: 700px;" class="DivGreen">
        <tr>
            <td align="left">
                <strong><span class="Labels">Click <a href="https://commercetechnologies.sharepoint.com/:w:/s/Team-Meetings/EUUpA8DpnGhLmCt-3ie7jy4BSNgkmgWbfeIxnBcw8KmutA?e=HySaVs">here </a> for Criteria to have account Funded</span></strong></td>
        </tr>
        <!--<tr>
            <td align="left">
