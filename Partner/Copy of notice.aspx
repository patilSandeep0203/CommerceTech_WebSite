<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Copy of notice.aspx.cs" Inherits="notice" Title="Commerce Technologies - Online Application" %>
                ...
                <!--<span style="color: #000000">
                    <asp:Panel ID="pnlGatewayIncomplete" runat="server" Height="50px" Width="100%" Visible="False">
                        ...
                        <asp:HyperLink ID="lnlGatewayIncomplete" runat="server" Font-Names="Arial" Font-Size="Small"
                            Font-Bold="True" NavigateUrl="/OnlineApplication/Gateway/reprogram.aspx">click here</asp:HyperLink>
