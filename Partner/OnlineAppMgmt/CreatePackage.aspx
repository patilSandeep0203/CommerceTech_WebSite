            ...
            <div>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="width: 880px;" class="DivGreen">
                            <tr>
                            ...
                            <tr>
                                <td align="center" colspan="8" style="height: 15px">
                                    <asp:CheckBox style="display:none;" ID="chkApplyInterchange" runat="server" TabIndex="4" AutoPostBack="True" Text="Apply Interchange Rates" Font-Size="8pt" OnCheckedChanged="chkApplyInterchange_CheckedChanged" />
                                    ...
                                    <asp:Panel ID="pnlMerchantRates" runat="server" Width="100%" Visible="True">
                                        ...
                                        <td align="left" style="height: 24px; width: 80px;">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" style="height: 24px; display:none;">
                                                    <asp:Label ID="lblDRQNP" runat="server" Text="Disc Rate Qual NP"></asp:Label>&nbsp;</td>
                                                <td align="left" style="height: 24px; display:none;">
                                                    ...
                                                    <td align="right" style="height: 30px; width: 230px;">
                                            <asp:Label ID="Label25" runat="server" Text="Amex Disc Mid Qual"></asp:Label>&nbsp;</td>
                                        <td align="left" style="height: 24px">
                                           ...
                                           <td align="right" >
                                                            &nbsp; &nbsp; &nbsp;
                                                                <asp:CheckBox ID="chkOnlineDebit" runat="server" AutoPostBack="True" Font-Bold="True"
                                                                    OnCheckedChanged="chkOnlineDebit_CheckedChanged" /></td>
                            ...
                            <tr>
                                <td align="left" colspan="10" style="height: 15px">
                                </td>
                            </tr>
                            <tr>
                                <td align="left" colspan="10">
                            ...
                            <tr>
                                <td style="height: 15px" align="left" colspan="10">
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="10">
                                    <asp:Panel ID="pnlNewsHeader" runat="server" Height="20px">
                                        <div style="cursor: pointer; vertical-align: middle; width: 830px;height: 20px; background-image: url(/PartnerPortal/Images/topMain.gif)">
                                    ...
                                    <asp:Panel ID="pnlNews" runat="server" Width="830px" Visible="True" CssClass="DivGreen">
