        ...
        <center>
            <div>
                <asp:ScriptManager ID="ScriptManager1" runat="server">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="width: 950px;" class="DivGreen">
                    <tr>
                        <td colspan="7" align="center" style="height: 25px; background-image: url(/PartnerPortal/Images/topMain.gif)">
                    ...
                    <tr>
                        <td style="height: 15px" colspan="7" align="center">
                    ...
                    <tr>
                        ...
                        <td align="left"colspan=2>
                            ...
                            <!--This is where I need to add the Billing Method dropdown-->
                                                <asp:DropDownList ID="lstRateNames" runat="server" AutoPostBack="True" OnSelectedIndexChanged="lstRateNames_SelectedIndexChanged" TabIndex="1">
                                                    <asp:ListItem Enabled="False" Text="" />
                                                    <asp:ListItem Text="Tiered" />
                                                    <asp:ListItem Text="Flat Rate" />
                                                    <asp:ListItem Text="Interchange" />
                                                    
                                                </asp:DropDownList>
                            <asp:CheckBox style="display:none;" ID="chkApplyInterchange" runat="server" AutoPostBack="True" Text="Interchange Rates" TabIndex="2" OnCheckedChanged="chkApplyInterchange_CheckedChanged"/><asp:CheckBox ID="chkBillAssessment" Visible=false runat="server" Text="Billing Assessments"/></td>
                        ...
                        <td align="left" colspan="7">
                            <asp:Panel ID="pnlMerchantRates" runat="server" Width="100%" Visible="True">
                                ...
                                <tr style="height: 24px;">
                                    ...
                                    <tr>
                                    <td align="right" style="height: 30px; width: 230px;">
                                            <asp:Label ID="lblDRQD" runat="server" Text="Qual Pres"></asp:Label>&nbsp;</td>
                                        <td align="left" style="height: 24px">
                                            <asp:TextBox ID="txtDRQD" runat="server" Width="40px" TabIndex="7" MaxLength="6"></asp:TextBox>
                                            <span class="LabelsSmall">%</span>
                                            </td>
                                            <td align="right" style="height: 30px; width: 230px;">
                                            <asp:Label ID="lblDRQP" runat="server" Text=""></asp:Label>&nbsp;</td>
                                        <td align="left" style="height: 24px;">
                                            <asp:TextBox ID="txtDRQP" runat="server" Width="40px" TabIndex="7" MaxLength="6"></asp:TextBox>
                                              <span class="LabelsSmall">%</span>
                                        </td>
                                            <td align="right" style="height: 30px; width: 230px;">
                                            <asp:Label ID="Label23" runat="server" Text=""></asp:Label>&nbsp;</td>
                                        <td align="left" style="height: 24px">
                                            <asp:TextBox ID="txtAmexQual" runat="server" Width="40px" TabIndex="7" MaxLength="6"></asp:TextBox>
                                            <span class="LabelsSmall">%</span>
                                            </td>
                                    ...
                                    <span class="LabelsSmall">Mid Qual</span>&nbsp;</td>
                                            <td align="left">
                                                <asp:TextBox ID="txtMidQualDebit" runat="server" Width="40px" TabIndex="8" MaxLength="6"></asp:TextBox>
                                                <span class="LabelsSmall">%</span>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender28" runat="server" TargetControlID="txtMidQualDebit"
                                                    FilterType="Custom, Numbers" ValidChars="." />
                                            </td>
                                        <td align="right" style="height: 30px; width: 230px;">
                                            <asp:Label ID="lblDRMQ" runat="server" Text=""></asp:Label>&nbsp;</td>
                                        <td align="left" style="height: 24px">
                                            ...
                                            <td align="left">
                                               <!--<asp:TextBox ID="txtQualNPDebit" runat="server" Width="40px" TabIndex="8" MaxLength="6"  AutoPostBack="true"></asp:TextBox>
                                                <span class="LabelsSmall">%</span>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender29" runat="server" TargetControlID="txtQualNPDebit"
                                                    FilterType="Custom, Numbers" ValidChars="." />
                                            </td>
                                    <td align="right" style="height: 30px; width: 230px;">
                                            <asp:Label ID="lblDRQNP" runat="server" Text=""></asp:Label>&nbsp;</td>
                                        <td align="left" style="height: 24px;">
                                        ...
                                        <td align="left" style="height: 24px">
                                            <asp:TextBox ID="txtAmexMidQual" runat="server" Width="40px" TabIndex="7" MaxLength="6"></asp:TextBox>
                                            <span class="LabelsSmall">%</span>
                                        </td>
                                    ...
                                    <td align="right">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtNonQualDebit" runat="server" Width="40px" TabIndex="8" MaxLength="6"></asp:TextBox>
                                                <span class="LabelsSmall">%</span>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender30" runat="server" TargetControlID="txtNonQualDebit"
                                                    FilterType="Custom, Numbers" ValidChars="." />
                                            </td>
                                    <td align="right" style="height: 30px; width: 230px;">
                                            <asp:Label ID="lblDRNQ" runat="server" Text=""></asp:Label>&nbsp;</td>
                                        <td align="left" style="height: 24px">
                                        ...
                                        <td align="left" style="height: 24px; width: 90px;">
                                            <asp:TextBox ID="txtAmexNonQual" runat="server" Width="40px" TabIndex="7" MaxLength="6"></asp:TextBox>
                                            <span class="LabelsSmall">%</span>
                                            </td>
                                    ...
                                    <tr>
                                        <td align="right" colspan="12" style="height: 15px">
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                                                    ...
                                                    <td align="left" colspan="2">
                                                        ...
                                                        <td align="left">
                                                            ...
                                                            <td align="left">
                                                             ...
                                                             <td align="right">
                                                                <asp:Label ID="lblPinDebitDiscount" runat="server" Text="Debit Discount"></asp:Label></td>
                                                            <td align="left">
                                                                &nbsp;<asp:Label ID="Label24" runat="server" Text="$"></asp:Label>
                                                                <asp:TextBox ID="txtPinDebitDiscount" runat="server" MaxLength="5" TabIndex="28" Width="36px"></asp:TextBox></td>
                                                            <td align="right">
                      ...
                      <tr>
                                                    <td align="center" colspan="8">
                                                        <asp:Panel ID="pnlEBT" runat="server" Visible="false" Width="100%">
                                                            ...
                                                            <tr>   
                                                            <td align="left" colspan="2">&nbsp; &nbsp; &nbsp;
                                                                <asp:CheckBox ID="chkEBT" runat="server" AutoPostBack="True" Font-Bold="True" 
                                                                    OnCheckedChanged="chkEBT_CheckedChanged" Text="Electronic Benefits Transfer (EBT)"/></td>
