                ...
                <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="500">
                    <ProgressTemplate>
                        <div class="DivHelp" style="width: 50%">
                            <asp:Image ID="imgProgress" runat="server" ImageUrl="/PartnerPortal/Images/indicator.gif" />
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="width: 740px;" class="DivGreen">
                            ...
                            <tr>
                                <td align="center" colspan="8" style="height: 15px">
                                    <asp:CheckBox ID="chkApplyInterchange" runat="server" TabIndex="4" AutoPostBack="True" Text="Apply Interchange Rates" Font-Size="8pt" />
