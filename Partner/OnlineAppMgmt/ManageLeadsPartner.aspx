<%@ Page Language="C#" MasterPageFile="~/OnlineAppMgmt/User.master" AutoEventWireup="true" CodeFile="ManageLeadsPartner.aspx.cs" Inherits="ManageLeadsPartner" Title="Commerce Technologies - Partner Portal" Theme="AppTheme" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 260px;"  class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="height: 25px; background-image: url(/Images/topMain.gif)">
                <b><span class="MenuHeader">apps.commercetech.com
                    Leads</span></b>
            </td>
        </tr>
        <tr>
