<%@ Page Language="C#" MasterPageFile="~/OnlineAppMgmt/Agent.master" AutoEventWireup="true"
    CodeFile="OnlineAppAgent.aspx.cs" Inherits="OnlineAppAgent" Title="Commerce Technologies - Partner Portal"
    Theme="Admin" %>
                        ...
                        <ContentTemplate>
                            ...
                            <tr>
                                                        <td align="right" style="width: 50%">
                                                             <asp:Label ID="lblRename" Font-Size="11px" Font-Names="Arial" runat="server" Font-Bold="True"
                                            Text="Select Rep Name" ForeColor="#383838"></asp:Label>
                                                        </td>
                                                        <td align="left">
