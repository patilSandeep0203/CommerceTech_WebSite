                        ...
                        <tr>
                            <td align="left" colspan="12">
                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                    ...
                                    <script src="fillRates.js"></script>
                                    <script src="fillRates.js"></script>
                                    <script src="fillRates.js"></script>
                                    ...
                                    <asp:Panel ID="pnlMerchantRates" runat="server" Width="100%" Visible="False">
                                        ...
                                        <tr height="15px">
                                            ...
                                            <td align="left" >
                                                <asp:Label ID="Label2" runat="server" AutoPostBack="True" Font-Bold="True" 
                                                Text="Billing Method" /></td>
                                            <td align="left" colspan="2">
                                       ...
                                       <td align="right">
                                        ...
                                        <td colspan = "2">
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:ListItem Text="Monthly" Selected="True"/>
                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" colspan="2" width="120px" >
                                                                <asp:DropDownList ID="lstGCType" runat="server" AutoPostBack="True" TabIndex="36" OnSelectedIndexChanged="lstGiftCard_SelectedIndexChanged">
                                                                    <asp:ListItem Text="Paya EFT Gift & Loyalty" />
