                ...
                <asp:ScriptManager ID="ScriptManager1" runat="server">
                    ...
                    <tr>
                        ...
                        <td align="left"colspan=2>
                            ...
                            <asp:CheckBox ID="chkApplyInterchange" runat="server" AutoPostBack="True" Text="Interchange Rates" TabIndex="2" /><asp:CheckBox ID="chkBillAssessment" Visible=false runat="server" Text="Billing Assessments"/></td>
                            ...
                            <asp:Panel ID="pnlGatewayRates" runat="server" Width="100%" Visible="True">
                                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtGWSetupFee" runat="server" Width="40px" TabIndex="25" MaxLength="4"></asp:TextBox></td>
                                        <td align="right">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 60%;">
                                                ...
                                                <tr>
                                                    <td align="center" colspan="5">
                                                        ...
                                                        <tr>
                                                            <td align="center" colspan="5">
                                                                <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Check Guarantee"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right">
