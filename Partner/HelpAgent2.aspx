        ...
        <a name="#00"></a>
            ...
            <tr>
                <td align="left">
                    ...
                    <span class="LabelsSmall">It usually take upto 3 business days for an ACH deposit to show up from the day it is 
                    posted until receipt. To check if a commission or residual was paid, click <a class="One" href="#05-3">here</a></span>
                    <br />
                    <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                    <hr noshade size="1" width="90%">
                    ...
                    <span class="LabelsSmall">It usually take upto 4 business days for a check from the day it is 
                    posted until receipt. To check if a commission or residual was paid, click <a class="One" href="#05-3">here</a></span>
                    <br />
                    <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                    <hr noshade size="1" width="90%">
                    ...
                    <span class="LabelsSmall">You can contact Charmaine Cruz at (310) 321-5400 Ext. 5404 on any questions regarding payments, residuals or commissions. You can refer to the 
                    Contact Us page for more information.</span>
                    <br />
                    <a class="LinkXSmall" href="#00" target="_self">Back to the top</a>
                    <hr noshade size="1" width="90%">
