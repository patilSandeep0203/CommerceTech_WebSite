...
namespace AjaxControlToolkit
{
    ...
    public class SlideShowExtender : ExtenderControlBase
    {
        ...
        public string SlideShowServiceMethod
        {
            get
            {
                return GetPropertyValue("SlideShowServiceMethod", "");
            }
            set
            {
                SetPropertyValue("SlideShowServiceMethod", value);
            }
        }
        ...
        public string SlideShowServicePath
        {
            get
            {
                return GetPropertyValue("SlideShowServicePath", "");
            }
            set
            {
                SetPropertyValue("SlideShowServicePath", value);
            }
        }
        ...
        public string NextButtonID
        {
            get
            {
                return GetPropertyValue("NextButtonID", "");
            }
            set
            {
                SetPropertyValue("NextButtonID", value);
            }
        }
        ...
        public string PlayButtonID
        {
            get
            {
                return GetPropertyValue("PlayButtonID", "");
            }
            set
            {
                SetPropertyValue("PlayButtonID", value);
            }
        }
        ...
        public string PlayButtonText
        {
            get
            {
                return GetPropertyValue("PlayButtonText", "");
            }
            set
            {
                SetPropertyValue("PlayButtonText", value);
            }
        }
        ...
        public string StopButtonText
        {
            get
            {
                return GetPropertyValue("StopButtonText", "");
            }
            set
            {
                SetPropertyValue("StopButtonText", value);
            }
        }
        ...
        public int PlayInterval
        {
            get
            {
                return GetPropertyValue("PlayInterval", 3000);
            }
            set
            {
                SetPropertyValue("PlayInterval", value);
            }
        }

        /// <summary>
        /// ID of the label that will display the current slide name and description.
        /// </summary>
        [ExtenderControlProperty]
        [DefaultValue("")]
        [IDReferenceProperty(typeof(WebControl))]
        ...
        public string ImageDescriptionLabelID
        {
            get
            {
                return GetPropertyValue("ImageDescriptionLabelID", "");
            }
            set
            {
                SetPropertyValue("ImageDescriptionLabelID", value);
            }
        }
        ...
        public string PreviousButtonID
        {
            get
            {
                return GetPropertyValue("PreviousButtonID", "");
            }
            set
            {
                SetPropertyValue("PreviousButtonID", value);
            }
        }
        ...
        public bool Loop
        {
            get
            {
                return GetPropertyValue("Loop", false);
            }
            set
            {
