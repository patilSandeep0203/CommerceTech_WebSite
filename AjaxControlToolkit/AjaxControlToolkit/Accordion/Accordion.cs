...
namespace AjaxControlToolkit
{
    ...
    public class Accordion : WebControl
    {
        ...
        /// <summary>
        /// Default CSS class of the child content panes
        /// </summary>
...
#region DataBinding Fields
        ...
        public int TransitionDuration
        {
            ...
            {
                EnsureChildControls();
                return _extender.TransitionDuration;
            }
            set
            {
                EnsureChildControls();
                _extender.TransitionDuration = value;
            }
        }
        ...
        public int FramesPerSecond
        {
            ...
            {
                EnsureChildControls();
                return _extender.FramesPerSecond;
            }
            set
            {
                EnsureChildControls();
                _extender.FramesPerSecond = value;
            }
        }
        ...
        public bool FadeTransitions
        {
            ...
            {
                EnsureChildControls();
                return _extender.FadeTransitions;
            }
            set
            {
                EnsureChildControls();
                _extender.FadeTransitions = value;
            }
        }
        ...
        public AutoSize AutoSize
        {
            ...
            {
                EnsureChildControls();
                return _extender.AutoSize;
            }
            set
            {
                EnsureChildControls();
                _extender.AutoSize = value;
            }
        }
        ...
        public int SelectedIndex
        {
            ...
            {
                EnsureChildControls();
                return _extender.SelectedIndex;
            }
            set
            {
                EnsureChildControls();
                _extender.SelectedIndex = value;
            }
        }
        ...
        public bool RequireOpenedPane
        {
            ...
            {
                EnsureChildControls();
                return _extender.RequireOpenedPane;
            }
            set
            {
                EnsureChildControls();
                _extender.RequireOpenedPane = value;
            }
        }
        ...
        public bool SuppressHeaderPostbacks
        {
            ...
            {
                EnsureChildControls();
                return _extender.SuppressHeaderPostbacks;
            }
            set
            {
                EnsureChildControls();
                _extender.SuppressHeaderPostbacks = value;
            }
        }
...
#region DataBinding Properties
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            {
                if (!string.IsNullOrEmpty(_headerCssClass) && string.IsNullOrEmpty(pane.HeaderCssClass))
                    pane.HeaderCssClass = _headerCssClass;
                if (!string.IsNullOrEmpty(_contentCssClass) && string.IsNullOrEmpty(pane.ContentCssClass))
                    pane.ContentCssClass = _contentCssClass;
            }
            ...
            // in this scenario.)
            int index = _extender.SelectedIndex;
            index = ((index < 0 || index >= Panes.Count) && _extender.RequireOpenedPane) ? 0 : index;
