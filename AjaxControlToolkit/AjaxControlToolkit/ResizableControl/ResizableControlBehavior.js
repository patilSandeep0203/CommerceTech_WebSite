...
AjaxControlToolkit.ResizableControlBehavior.prototype = {
    initialize : function() {
        ...
        this._lining.style.width = CommonToolkitScripts.getCurrentStyle(this._frame, 'width');
        this._lining.style.height = CommonToolkitScripts.getCurrentStyle(this._frame, 'height');
    ...
    get_Size : function() {
        ...
        /// </value>
        return { width: this._measurementToNumber(CommonToolkitScripts.getCurrentStyle(this._lining, 'width')),
            height: this._measurementToNumber(CommonToolkitScripts.getCurrentStyle(this._lining, 'height'))};
    },
    set_Size : function(value) {
        var deltaX = value.width-this._measurementToNumber(CommonToolkitScripts.getCurrentStyle(this._lining, 'width'));
        var deltaY = value.height-this._measurementToNumber(CommonToolkitScripts.getCurrentStyle(this._lining, 'height'));
