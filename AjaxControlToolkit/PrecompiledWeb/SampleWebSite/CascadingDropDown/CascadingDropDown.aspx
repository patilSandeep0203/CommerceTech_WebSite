<%@ page language="C#" masterpagefile="~/DefaultMaster.master" autoeventwireup="true" inherits="CascadingDropDown_CascadingDropDown, App_Web_vhqd3apd" title="CascadingDropDown Sample" enableeventvalidation="false" theme="SampleSiteTheme" %>
<%@ Register
    ...
    <em>SelectedValue</em>="SomeValue" /&gt;</pre>
        <ul>
            ...
            <li><strong>ServicePath</strong> - Path to a web service that returns the data used to populate
                ...
                The web service should be decorated with the Microsoft.Web.Script.Services.ScriptService
                attribute.</li>
