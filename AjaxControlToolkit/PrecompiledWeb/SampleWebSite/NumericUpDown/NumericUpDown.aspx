<%@ page language="C#" masterpagefile="~/DefaultMaster.master" autoeventwireup="true" inherits="NumericUpDown_NumericUpDown, App_Web_2ra76ooq" title="NumericUpDown Sample" theme="SampleSiteTheme" %>
<%@ Register
    ...
    <em>Tag</em>="1" /&gt;</pre>
        <ul>
            ...
            <li><strong>ServiceDownPath/ServiceUpPath</strong> - Path to a web service that returns the
                ...
                Microsoft.Web.Script.Services.ScriptService attribute.</li>
